...
export class AbsoluteAnchorSize extends OpenXmlCompositeElement {
    ...
    // (undocumented)
    readonly localName: "absSizeAnchor";
    // (undocumented)
    readonly namespaceUri: "http://schemas.openxmlformats.org/drawingml/2006/chartDrawing";
    // (undocumented)
    readonly prefix: "cdr";
}
...
// @public
export class FromAnchor extends OpenXmlCompositeElement {
    // (undocumented)
    readonly children: OpenXmlElementList;
    // (undocumented)
...
export class RelativeAnchorSize extends OpenXmlCompositeElement {
    ...
    readonly children: OpenXmlElementList;
    // (undocumented)
    readonly localName: "relSizeAnchor";
    // (undocumented)
    readonly namespaceUri: "http://schemas.openxmlformats.org/drawingml/2006/chartDrawing";
    // (undocumented)
    readonly prefix: "cdr";
...
// @public
export class ToAnchor extends OpenXmlCompositeElement {
    // (undocumented)
    readonly children: OpenXmlElementList;
    // (undocumented)
...
// @public
export class XPosition extends OpenXmlLeafElement {
    // (undocumented)
...
// @public
export class YPosition extends OpenXmlLeafElement {
    // (undocumented)

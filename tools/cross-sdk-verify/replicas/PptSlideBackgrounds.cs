// Replica of examples/ppt-slide-backgrounds.ts
// Creates a pptx with 1 slide; final background color = FFFF00 (yellow).
...
public static class PptSlideBackgrounds
{
    public static void Run(string outputPath)
    {
        ...
        // Background: solid fill FFFF00 (yellow) — final state of the TS example
        var background = new Background(
            new BackgroundProperties(
                new A.SolidFill(
                    new A.RgbColorModelHex { Val = "FFFF00" })
            )
        );

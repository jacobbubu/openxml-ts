// Replica of examples/ppt-picture-crop.ts
// Creates a pptx with 1 slide containing a 1x1 PNG image with crop applied:
...
public static class PptPictureCrop
{
    ...
    public static void Run(string outputPath)
    {
        ...
        // Position and size matching the TS example
        long xEmu = (long)(914400L * 4);
        long yEmu = (long)(914400L * 2.75);
        long cxEmu = 914400L * 2;
        long cyEmu = 914400L * 2;

        // Crop: left=10%, top=5%, right=0%, bottom=5%
        // DrawingML srcRect uses 1/1000 of a percent (permill of 100000 = 100%).
        // 10% = 100000, 5% = 50000, 0% = 0.
        ...
        var pic = new P.Picture(
            new P.NonVisualPictureProperties(
                new P.NonVisualDrawingProperties { Id = 10, Name = "CroppedImage" },

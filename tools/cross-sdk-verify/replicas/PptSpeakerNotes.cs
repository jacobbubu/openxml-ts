// Replica of examples/ppt-speaker-notes.ts
// Creates a pptx with 1 slide and speaker notes on slide 0.
...
public static class PptSpeakerNotes
{
    private const string NotesText = "Welcome the audience. Mention agenda: intro, demo, Q&A.";
    ...
    public static void Run(string outputPath)
    {
        ...
        // Notes slide master (required for notes)
        var notesMasterPart = presPart.AddNewPart<NotesMasterPart>("rIdNotesMaster1");
        ...
        presPart.Presentation.Append(
            ...
            new NotesMasterIdList(new NotesMasterId()),
            slideIdList,
        ...
        // Notes slide with body placeholder containing the notes text
        var notesSlidePart = slidePart.AddNewPart<NotesSlidePart>("rIdNotes1");
        notesSlidePart.AddPart(notesMasterPart, "rIdNotesMaster1");
                ...
                new ShapeTree(
                    ...
                    new Shape(
                        new NonVisualShapeProperties(
                            new NonVisualDrawingProperties { Id = 2, Name = "Notes Placeholder 1" },

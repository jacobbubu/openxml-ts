// Replica of examples/ppt-add-notes.ts
// Creates a pptx with 1 slide and speaker notes set via setSlideNotes(0, ...).
...
public static class PptAddNotes
{
    private const string NotesText = "Welcome the audience. Mention agenda items: intro, demo, Q&A.";
    ...
    public static void Run(string outputPath)
    {
        ...
        // Notes master (required for notes)
        ...
        // Slide 1 (empty body, notes will be added)

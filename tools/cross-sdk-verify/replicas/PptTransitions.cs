// Replica of examples/ppt-transitions.ts
// Creates a pptx with 1 slide; final transition effect = "push", speed="fast", advanceOnClick=true.
// (The TS example loops through effects then clears then sets push/fast/advanceOnClick.)
...
public static class PptTransitions
{
    public static void Run(string outputPath)
    {
        ...
        // Final state: push, fast, advanceOnClick=true
        var transition = new Transition
        {
            Speed = TransitionSpeedValues.Fast,
            AdvanceOnClick = true
        };
        // "push" effect maps to PushTransition in DrawingML
        transition.Append(new PushTransition());

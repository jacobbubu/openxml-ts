...
export function seedPresentationXml(opts: {
  ...
  return (
    ...
    `<p:sldMasterIdLst><p:sldMasterId id="2147483648" r:id="${opts.slideMasterRId}"/></p:sldMasterIdLst>` +
    `<p:sldIdLst><p:sldId id="256" r:id="${opts.slideRId}"/></p:sldIdLst>` +
...
export function seedSlideLayoutXml(): string {
  return (
    `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>` +
    `<p:sldLayout xmlns:p="${P}" xmlns:r="${R}" xmlns:a="${A}" type="blank" preserve="1">` +
...
export function seedSlideMasterXml(opts: { slideLayoutRId: string }): string {
  return (
    `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>` +
    `<p:sldMaster xmlns:p="${P}" xmlns:r="${R}" xmlns:a="${A}">` +
    `<p:cSld>` +
    ...
    `<p:sldLayoutIdLst><p:sldLayoutId id="2147483649" r:id="${opts.slideLayoutRId}"/></p:sldLayoutIdLst>` +

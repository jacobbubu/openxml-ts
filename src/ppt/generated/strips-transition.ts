...
// @see DocumentFormat.OpenXml.Presentation.StripsTransition
 ...
 *
 * Element: `p:strips` */
export class StripsTransition extends OpenXmlLeafElement {
  override readonly localName = "strips" as const;

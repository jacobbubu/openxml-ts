...
// @see DocumentFormat.OpenXml.Presentation.BuildOleChart
...
/** Build OLE Chart.
 *
 * Element: `p:bldOleChart` */
export class BuildOleChart extends OpenXmlLeafElement {
  override readonly localName = "bldOleChart" as const;
  ...
  validateRequired(): void {
    assertRequired(this.shapeId, { attribute: ":spid", elementClass: "BuildOleChart" });
    assertRequired(this.groupId, { attribute: ":grpId", elementClass: "BuildOleChart" });
  }
}

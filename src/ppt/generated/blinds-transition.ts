...
// @see DocumentFormat.OpenXml.Presentation.BlindsTransition
 ...
 *
 * Element: `p:blinds` */
export class BlindsTransition extends OpenXmlLeafElement {
  override readonly localName = "blinds" as const;

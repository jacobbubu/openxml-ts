...
// @see DocumentFormat.OpenXml.Presentation.Sound
 ...
 *
 * Element: `p:snd` */
export class Sound extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.embed, { attribute: "r:embed", elementClass: "Sound" });
  }
}

...
// @see DocumentFormat.OpenXml.Presentation.CoverTransition
 ...
 *
 * Element: `p:cover` */
export class CoverTransition extends OpenXmlLeafElement {
  override readonly localName = "cover" as const;

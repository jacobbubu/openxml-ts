...
// @see DocumentFormat.OpenXml.Presentation.RandomBarTransition
 ...
 *
 * Element: `p:randomBar` */
export class RandomBarTransition extends OpenXmlLeafElement {
  override readonly localName = "randomBar" as const;

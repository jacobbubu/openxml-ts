...
// @see DocumentFormat.OpenXml.Presentation.Tag
...
export class Tag extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.name, { attribute: ":name", elementClass: "Tag" });
    assertRequired(this.val, { attribute: ":val", elementClass: "Tag" });
  }
}

...
// @see DocumentFormat.OpenXml.Excel2010.SlicerCachePivotTables
 ...
 *
 * Element: `x15:slicerCachePivotTables` */
export class SlicerCachePivotTables extends OpenXmlCompositeElement {
  override readonly localName = "slicerCachePivotTables" as const;

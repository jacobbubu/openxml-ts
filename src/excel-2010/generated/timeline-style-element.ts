...
// @see DocumentFormat.OpenXml.Excel2010.TimelineStyleElement
 ...
 *
 * Element: `x15:timelineStyleElement` */
export class TimelineStyleElement extends OpenXmlLeafElement {
  override readonly localName = "timelineStyleElement" as const;
  ...
  validateRequired(): void {
    assertRequired(this.type, { attribute: ":type", elementClass: "TimelineStyleElement" });
  }
}

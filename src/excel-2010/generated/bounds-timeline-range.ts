...
// @see DocumentFormat.OpenXml.Excel2010.BoundsTimelineRange
...
export class BoundsTimelineRange extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.startDate, { attribute: ":startDate", elementClass: "BoundsTimelineRange" });
    assertRequired(this.endDate, { attribute: ":endDate", elementClass: "BoundsTimelineRange" });
  }
}

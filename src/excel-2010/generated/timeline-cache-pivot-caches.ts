...
// @see DocumentFormat.OpenXml.Excel2010.TimelineCachePivotCaches
 ...
 *
 * Element: `x15:timelineCachePivotCaches` */
export class TimelineCachePivotCaches extends OpenXmlCompositeElement {
  override readonly localName = "timelineCachePivotCaches" as const;

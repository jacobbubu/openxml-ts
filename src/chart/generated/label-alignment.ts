...
// @see DocumentFormat.OpenXml.Chart.LabelAlignment
...
export class LabelAlignment extends OpenXmlLeafElement {
  override readonly localName = "lblAlgn" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "LabelAlignment" });
  }
}

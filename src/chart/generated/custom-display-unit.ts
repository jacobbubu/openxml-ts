...
// @see DocumentFormat.OpenXml.Chart.CustomDisplayUnit
...
export class CustomDisplayUnit extends OpenXmlLeafElement {
  override readonly localName = "custUnit" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "CustomDisplayUnit" });
  }
}

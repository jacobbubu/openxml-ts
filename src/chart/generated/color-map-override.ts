...
// @see DocumentFormat.OpenXml.Chart.ColorMapOverride
...
export class ColorMapOverride extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.background1, { attribute: ":bg1", elementClass: "ColorMapOverride" });
    assertRequired(this.text1, { attribute: ":tx1", elementClass: "ColorMapOverride" });
    assertRequired(this.background2, { attribute: ":bg2", elementClass: "ColorMapOverride" });
    assertRequired(this.text2, { attribute: ":tx2", elementClass: "ColorMapOverride" });
    assertRequired(this.accent1, { attribute: ":accent1", elementClass: "ColorMapOverride" });
    assertRequired(this.accent2, { attribute: ":accent2", elementClass: "ColorMapOverride" });
    assertRequired(this.accent3, { attribute: ":accent3", elementClass: "ColorMapOverride" });
    assertRequired(this.accent4, { attribute: ":accent4", elementClass: "ColorMapOverride" });
    assertRequired(this.accent5, { attribute: ":accent5", elementClass: "ColorMapOverride" });
    assertRequired(this.accent6, { attribute: ":accent6", elementClass: "ColorMapOverride" });
    assertRequired(this.hyperlink, { attribute: ":hlink", elementClass: "ColorMapOverride" });
    assertRequired(this.followedHyperlink, { attribute: ":folHlink", elementClass: "ColorMapOverride" });
  }
}

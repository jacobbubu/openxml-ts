...
// @see DocumentFormat.OpenXml.Chart.BarDirection
...
export class BarDirection extends OpenXmlLeafElement {
  override readonly localName = "barDir" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "BarDirection" });
  }
}

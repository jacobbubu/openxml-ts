...
// @see DocumentFormat.OpenXml.Chart.PictureFormat
...
/** Picture Format.
 *
 * Element: `c:pictureFormat` */
export class PictureFormat extends OpenXmlLeafElement {
  override readonly localName = "pictureFormat" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "PictureFormat" });
  }
}

...
// @see DocumentFormat.OpenXml.Chart.UserShapesReference
 ...
 *
 * Element: `c:userShapes` */
export class UserShapesReference extends OpenXmlLeafElement {
  override readonly localName = "userShapes" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "r:id", elementClass: "UserShapesReference" });
  }
}

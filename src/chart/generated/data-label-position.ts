...
// @see DocumentFormat.OpenXml.Chart.DataLabelPosition
...
export class DataLabelPosition extends OpenXmlLeafElement {
  override readonly localName = "dLblPos" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "DataLabelPosition" });
  }
}

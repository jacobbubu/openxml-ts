...
// @see DocumentFormat.OpenXml.Chart.ErrorDirection
...
export class ErrorDirection extends OpenXmlLeafElement {
  override readonly localName = "errDir" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "ErrorDirection" });
  }
}

...
// @see DocumentFormat.OpenXml.Chart.Symbol
 ...
 *
 * Element: `c:symbol` */
export class Symbol extends OpenXmlLeafElement {
  override readonly localName = "symbol" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "Symbol" });
  }
}

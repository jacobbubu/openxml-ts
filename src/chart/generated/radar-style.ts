...
// @see DocumentFormat.OpenXml.Chart.RadarStyle
 ...
 *
 * Element: `c:radarStyle` */
export class RadarStyle extends OpenXmlLeafElement {
  override readonly localName = "radarStyle" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "RadarStyle" });
  }
}

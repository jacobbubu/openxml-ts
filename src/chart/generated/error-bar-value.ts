...
// @see DocumentFormat.OpenXml.Chart.ErrorBarValue
...
export class ErrorBarValue extends OpenXmlLeafElement {
  override readonly localName = "val" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "ErrorBarValue" });
  }
}

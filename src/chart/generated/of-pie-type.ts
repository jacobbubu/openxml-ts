...
// @see DocumentFormat.OpenXml.Chart.OfPieType
...
export class OfPieType extends OpenXmlLeafElement {
  override readonly localName = "ofPieType" as const;
  ...
  /** Pie of Pie or Bar of Pie Type Value (:val) */
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "OfPieType" });
  }
}

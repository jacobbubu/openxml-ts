...
// @see DocumentFormat.OpenXml.Chart.PolynomialOrder
...
export class PolynomialOrder extends OpenXmlLeafElement {
  override readonly localName = "order" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "PolynomialOrder" });
  }
}

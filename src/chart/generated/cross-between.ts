...
// @see DocumentFormat.OpenXml.Chart.CrossBetween
 ...
 *
 * Element: `c:crossBetween` */
export class CrossBetween extends OpenXmlLeafElement {
  override readonly localName = "crossBetween" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "CrossBetween" });
  }
}

...
// @see DocumentFormat.OpenXml.Chart.PictureStackUnit
...
/** Picture Stack Unit.
 *
 * Element: `c:pictureStackUnit` */
export class PictureStackUnit extends OpenXmlLeafElement {
  override readonly localName = "pictureStackUnit" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "PictureStackUnit" });
  }
}

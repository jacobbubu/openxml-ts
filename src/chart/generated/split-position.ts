...
// @see DocumentFormat.OpenXml.Chart.SplitPosition
...
export class SplitPosition extends OpenXmlLeafElement {
  override readonly localName = "splitPos" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "SplitPosition" });
  }
}

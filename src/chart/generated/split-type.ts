...
// @see DocumentFormat.OpenXml.Chart.SplitType
...
export class SplitType extends OpenXmlLeafElement {
  override readonly localName = "splitType" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "SplitType" });
  }
}

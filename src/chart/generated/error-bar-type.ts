...
// @see DocumentFormat.OpenXml.Chart.ErrorBarType
...
export class ErrorBarType extends OpenXmlLeafElement {
  override readonly localName = "errBarType" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "ErrorBarType" });
  }
}

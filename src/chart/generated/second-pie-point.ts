...
// @see DocumentFormat.OpenXml.Chart.SecondPiePoint
...
/** Second Pie Point.
 *
 * Element: `c:secondPiePt` */
export class SecondPiePoint extends OpenXmlLeafElement {
  override readonly localName = "secondPiePt" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "SecondPiePoint" });
  }
}

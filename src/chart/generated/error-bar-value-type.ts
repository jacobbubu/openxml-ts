...
// @see DocumentFormat.OpenXml.Chart.ErrorBarValueType
 ...
 *
 * Element: `c:errValType` */
export class ErrorBarValueType extends OpenXmlLeafElement {
  override readonly localName = "errValType" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "ErrorBarValueType" });
  }
}

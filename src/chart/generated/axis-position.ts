...
// @see DocumentFormat.OpenXml.Chart.AxisPosition
...
export class AxisPosition extends OpenXmlLeafElement {
  override readonly localName = "axPos" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "AxisPosition" });
  }
}

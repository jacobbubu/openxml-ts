...
// @see DocumentFormat.OpenXml.Chart.MinorUnit
...
export class MinorUnit extends OpenXmlLeafElement {
  override readonly localName = "minorUnit" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "MinorUnit" });
  }
}

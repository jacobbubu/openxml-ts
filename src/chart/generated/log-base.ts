...
// @see DocumentFormat.OpenXml.Chart.LogBase
...
export class LogBase extends OpenXmlLeafElement {
  override readonly localName = "logBase" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "LogBase" });
  }
}

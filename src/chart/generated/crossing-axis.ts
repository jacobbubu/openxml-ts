...
// @see DocumentFormat.OpenXml.Chart.CrossingAxis
...
export class CrossingAxis extends OpenXmlLeafElement {
  override readonly localName = "crossAx" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "CrossingAxis" });
  }
}

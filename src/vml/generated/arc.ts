...
// @see DocumentFormat.OpenXml.Vml.Arc
...
export class Arc extends OpenXmlCompositeElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "o:spt": this.optionalNumber = Int32Value.parse(value); assertNumber(this.optionalNumber, { min: 0, max: 202 }, { attribute: "o:spt", elementClass: "Arc" }); return;
      ...
      case "id": this.id = StringValue.parse(value); assertString(this.id, { maxLength: 255 }, { attribute: ":id", elementClass: "Arc" }); return;
      ...
      case "wrapcoords": this.wrapcoords = StringValue.parse(value); return;
      case "print": this.print = TrueFalseValue.parse(value); return;
      case "startangle": this.startAngle = DecimalValue.parse(value); return;
      case "endangle": this.endAngle = DecimalValue.parse(value); return;
    }
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.wrapcoords !== undefined) out.push(["wrapcoords", this.wrapcoords.toString()]);
    if (this.print !== undefined) out.push(["print", this.print.toString()]);
    if (this.startAngle !== undefined) out.push(["startangle", this.startAngle.toString()]);
    if (this.endAngle !== undefined) out.push(["endangle", this.endAngle.toString()]);
    return out;
  }

...
// @see DocumentFormat.OpenXml.Vml.Shapetype
...
export class Shapetype extends OpenXmlCompositeElement {
  override readonly localName = "shapetype" as const;
  ...
  /** Master Element Toggle (o:master) */
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "o:spt": this.optionalNumber = Int32Value.parse(value); assertNumber(this.optionalNumber, { min: 0, max: 202 }, { attribute: "o:spt", elementClass: "Shapetype" }); return;
      ...
      case "o:master": this.master = StringValue.parse(value); return;
    }
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.master !== undefined) out.push(["o:master", this.master.toString()]);
    return out;
  }

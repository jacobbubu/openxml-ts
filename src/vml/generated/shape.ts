...
// @see DocumentFormat.OpenXml.Vml.Shape
...
export class Shape extends OpenXmlCompositeElement {
  ...
  /** Shape Type Reference (:type) */
  type: StringValue | undefined;

  /** Adjustment Parameters (:adj) */
  adjustment: StringValue | undefined;

  /** Edge Path (:path) */
  edgePath: StringValue | undefined;

  /** Encoded Package (o:gfxdata) */
  encodedPackage: Base64BinaryValue | undefined;

  /** Storage for Alternate Math Content (:equationxml) */
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "o:spt": this.optionalNumber = Int32Value.parse(value); assertNumber(this.optionalNumber, { min: 0, max: 202 }, { attribute: "o:spt", elementClass: "Shape" }); return;
      ...
      case "adj": this.adjustment = StringValue.parse(value); return;
      case "path": this.edgePath = StringValue.parse(value); return;
      case "o:gfxdata": this.encodedPackage = Base64BinaryValue.parse(value); return;
      case "equationxml": this.equationXml = StringValue.parse(value); return;
    }
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.adjustment !== undefined) out.push(["adj", this.adjustment.toString()]);
    if (this.edgePath !== undefined) out.push(["path", this.edgePath.toString()]);
    if (this.encodedPackage !== undefined) out.push(["o:gfxdata", this.encodedPackage.toString()]);
    if (this.equationXml !== undefined) out.push(["equationxml", this.equationXml.toString()]);
    return out;
  }

...
// @see DocumentFormat.OpenXml.Vml.RoundRectangle
...
export class RoundRectangle extends OpenXmlCompositeElement {
  override readonly localName = "roundrect" as const;
  ...
  /** Rounded Corner Arc Size (:arcsize) */
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "o:spt": this.optionalNumber = Int32Value.parse(value); assertNumber(this.optionalNumber, { min: 0, max: 202 }, { attribute: "o:spt", elementClass: "RoundRectangle" }); return;
      ...
      case "arcsize": this.arcSize = StringValue.parse(value); return;
    }
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.arcSize !== undefined) out.push(["arcsize", this.arcSize.toString()]);
    return out;
  }

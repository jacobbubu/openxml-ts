...
// @see DocumentFormat.OpenXml.Vml.Line
...
export class Line extends OpenXmlCompositeElement {
  override readonly localName = "line" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "o:spt": this.optionalNumber = Int32Value.parse(value); assertNumber(this.optionalNumber, { min: 0, max: 202 }, { attribute: "o:spt", elementClass: "Line" }); return;

...
// @see DocumentFormat.OpenXml.Math.DefaultJustification
...
export class DefaultJustification extends OpenXmlLeafElement {
  override readonly localName = "defJc" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "DefaultJustification" });
  }
}

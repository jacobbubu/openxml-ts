...
// @see DocumentFormat.OpenXml.Math.ArgumentSize
...
export class ArgumentSize extends OpenXmlLeafElement {
  override readonly localName = "argSz" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "ArgumentSize" });
  }
}

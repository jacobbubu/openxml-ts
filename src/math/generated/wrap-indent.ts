...
// @see DocumentFormat.OpenXml.Math.WrapIndent
...
export class WrapIndent extends OpenXmlLeafElement {
  override readonly localName = "wrapIndent" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "m:val": this.val = UInt32Value.parse(value); assertNumber(this.val, { max: 31680 }, { attribute: "m:val", elementClass: "WrapIndent" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "WrapIndent" });
  }
}

...
// @see DocumentFormat.OpenXml.Math.ColumnGapRule
...
export class ColumnGapRule extends OpenXmlLeafElement {
  override readonly localName = "cGpRule" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "ColumnGapRule" });
  }
}

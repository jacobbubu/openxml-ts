...
// @see DocumentFormat.OpenXml.Math.NaryLimitLocation
...
export class NaryLimitLocation extends OpenXmlLeafElement {
  override readonly localName = "naryLim" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "NaryLimitLocation" });
  }
}

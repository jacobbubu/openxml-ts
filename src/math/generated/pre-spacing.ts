...
// @see DocumentFormat.OpenXml.Math.PreSpacing
...
export class PreSpacing extends OpenXmlLeafElement {
  override readonly localName = "preSp" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "m:val": this.val = UInt32Value.parse(value); assertNumber(this.val, { max: 31680 }, { attribute: "m:val", elementClass: "PreSpacing" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "PreSpacing" });
  }
}

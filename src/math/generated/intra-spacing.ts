...
// @see DocumentFormat.OpenXml.Math.IntraSpacing
...
export class IntraSpacing extends OpenXmlLeafElement {
  override readonly localName = "intraSp" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "m:val": this.val = UInt32Value.parse(value); assertNumber(this.val, { max: 31680 }, { attribute: "m:val", elementClass: "IntraSpacing" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "IntraSpacing" });
  }
}

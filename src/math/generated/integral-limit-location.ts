...
// @see DocumentFormat.OpenXml.Math.IntegralLimitLocation
...
export class IntegralLimitLocation extends OpenXmlLeafElement {
  override readonly localName = "intLim" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "IntegralLimitLocation" });
  }
}

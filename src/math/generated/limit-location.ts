...
// @see DocumentFormat.OpenXml.Math.LimitLocation
...
export class LimitLocation extends OpenXmlLeafElement {
  override readonly localName = "limLoc" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "LimitLocation" });
  }
}

...
// @see DocumentFormat.OpenXml.Math.VerticalJustification
...
export class VerticalJustification extends OpenXmlLeafElement {
  override readonly localName = "vertJc" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "VerticalJustification" });
  }
}

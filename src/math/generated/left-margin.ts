...
// @see DocumentFormat.OpenXml.Math.LeftMargin
...
export class LeftMargin extends OpenXmlLeafElement {
  override readonly localName = "lMargin" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "m:val": this.val = UInt32Value.parse(value); assertNumber(this.val, { max: 31680 }, { attribute: "m:val", elementClass: "LeftMargin" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "LeftMargin" });
  }
}

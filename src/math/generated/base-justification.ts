...
// @see DocumentFormat.OpenXml.Math.BaseJustification
...
export class BaseJustification extends OpenXmlLeafElement {
  override readonly localName = "baseJc" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "BaseJustification" });
  }
}

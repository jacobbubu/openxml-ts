...
// @see DocumentFormat.OpenXml.Math.InterSpacing
...
export class InterSpacing extends OpenXmlLeafElement {
  override readonly localName = "interSp" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "m:val": this.val = UInt32Value.parse(value); assertNumber(this.val, { max: 31680 }, { attribute: "m:val", elementClass: "InterSpacing" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "InterSpacing" });
  }
}

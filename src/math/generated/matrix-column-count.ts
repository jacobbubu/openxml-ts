...
// @see DocumentFormat.OpenXml.Math.MatrixColumnCount
...
export class MatrixColumnCount extends OpenXmlLeafElement {
  override readonly localName = "count" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "MatrixColumnCount" });
  }
}

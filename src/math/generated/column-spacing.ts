...
// @see DocumentFormat.OpenXml.Math.ColumnSpacing
...
export class ColumnSpacing extends OpenXmlLeafElement {
  override readonly localName = "cSp" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "m:val": this.val = UInt32Value.parse(value); assertNumber(this.val, { max: 31680 }, { attribute: "m:val", elementClass: "ColumnSpacing" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "ColumnSpacing" });
  }
}

...
// @see DocumentFormat.OpenXml.Math.MatrixColumnJustification
...
export class MatrixColumnJustification extends OpenXmlLeafElement {
  override readonly localName = "mcJc" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "MatrixColumnJustification" });
  }
}

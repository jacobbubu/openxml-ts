...
// @see DocumentFormat.OpenXml.Math.RowSpacingRule
...
export class RowSpacingRule extends OpenXmlLeafElement {
  override readonly localName = "rSpRule" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "m:val", elementClass: "RowSpacingRule" });
  }
}

...
// @see DocumentFormat.OpenXml.ChartEx.GeoChildEntitiesQueryResults
 ...
 *
 * Element: `cx:geoChildEntitiesQueryResults` */
export class GeoChildEntitiesQueryResults extends OpenXmlCompositeElement {
  override readonly localName = "geoChildEntitiesQueryResults" as const;

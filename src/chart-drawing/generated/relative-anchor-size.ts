...
// @see DocumentFormat.OpenXml.ChartDrawing.RelativeAnchorSize
 ...
 *
 * Element: `cdr:relSizeAnchor` */
export class RelativeAnchorSize extends OpenXmlCompositeElement {
  override readonly localName = "relSizeAnchor" as const;

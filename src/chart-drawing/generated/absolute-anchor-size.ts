...
// @see DocumentFormat.OpenXml.ChartDrawing.AbsoluteAnchorSize
 ...
 *
 * Element: `cdr:absSizeAnchor` */
export class AbsoluteAnchorSize extends OpenXmlCompositeElement {
  override readonly localName = "absSizeAnchor" as const;

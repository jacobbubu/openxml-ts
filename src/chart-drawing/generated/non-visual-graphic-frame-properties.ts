...
// @see DocumentFormat.OpenXml.ChartDrawing.NonVisualGraphicFrameProperties
 ...
 *
 * Element: `cdr:nvGraphicFramePr` */
export class NonVisualGraphicFrameProperties extends OpenXmlCompositeElement {
  override readonly localName = "nvGraphicFramePr" as const;

...
// @see DocumentFormat.OpenXml.Word2010.HueModulation
...
export class HueModulation extends OpenXmlLeafElement {
  override readonly localName = "hueMod" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w14:val": this.val = Int32Value.parse(value); assertNumber(this.val, { min: 0 }, { attribute: "w14:val", elementClass: "HueModulation" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "HueModulation" });
  }
}

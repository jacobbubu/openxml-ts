...
// @see DocumentFormat.OpenXml.Word2010.CustomXmlConflictDeletionRangeEnd
 ...
 *
 * Element: `w14:customXmlConflictDelRangeEnd` */
export class CustomXmlConflictDeletionRangeEnd extends OpenXmlLeafElement {
  override readonly localName = "customXmlConflictDelRangeEnd" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "w:id", elementClass: "CustomXmlConflictDeletionRangeEnd" });
  }
}

...
// @see DocumentFormat.OpenXml.Word2010.Shade
...
export class Shade extends OpenXmlLeafElement {
  override readonly localName = "shade" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w14:val": this.val = Int32Value.parse(value); assertNumber(this.val, { min: 0, max: 100000 }, { attribute: "w14:val", elementClass: "Shade" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "Shade" });
  }
}

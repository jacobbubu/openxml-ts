...
// @see DocumentFormat.OpenXml.Word2010.SchemeColor
 ...
 *
 * Element: `w14:schemeClr` */
export class SchemeColor extends OpenXmlCompositeElement {
  override readonly localName = "schemeClr" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "SchemeColor" });
  }
}

...
// @see DocumentFormat.OpenXml.Word2010.NumberingFormat
...
export class NumberingFormat extends OpenXmlLeafElement {
  override readonly localName = "numForm" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "NumberingFormat" });
  }
}

...
// @see DocumentFormat.OpenXml.Word2010.Tint
...
export class Tint extends OpenXmlLeafElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w14:val": this.val = Int32Value.parse(value); assertNumber(this.val, { min: 0, max: 100000 }, { attribute: "w14:val", elementClass: "Tint" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "Tint" });
  }
}

...
// @see DocumentFormat.OpenXml.Word2010.SaturationOffset
...
export class SaturationOffset extends OpenXmlLeafElement {
  override readonly localName = "satOff" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "SaturationOffset" });
  }
}

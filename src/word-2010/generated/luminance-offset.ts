...
// @see DocumentFormat.OpenXml.Word2010.LuminanceOffset
...
export class LuminanceOffset extends OpenXmlLeafElement {
  override readonly localName = "lumOff" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "LuminanceOffset" });
  }
}

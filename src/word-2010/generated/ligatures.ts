...
// @see DocumentFormat.OpenXml.Word2010.Ligatures
...
export class Ligatures extends OpenXmlLeafElement {
  override readonly localName = "ligatures" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "Ligatures" });
  }
}

...
// @see DocumentFormat.OpenXml.Word2010.DocumentId
...
export class DocumentId extends OpenXmlLeafElement {
  override readonly localName = "docId" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "DocumentId" });
  }
}

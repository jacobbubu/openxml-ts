...
// @see DocumentFormat.OpenXml.Word2010.CustomXmlConflictInsertionRangeStart
 ...
 *
 * Element: `w14:customXmlConflictInsRangeStart` */
export class CustomXmlConflictInsertionRangeStart extends OpenXmlLeafElement {
  override readonly localName = "customXmlConflictInsRangeStart" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "CustomXmlConflictInsertionRangeStart" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "CustomXmlConflictInsertionRangeStart" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "CustomXmlConflictInsertionRangeStart" });
  }
}

...
// @see DocumentFormat.OpenXml.Word2010.ConflictDeletion
...
export class ConflictDeletion extends OpenXmlLeafElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "ConflictDeletion" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "ConflictDeletion" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "ConflictDeletion" });
  }
}

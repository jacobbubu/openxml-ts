...
// @see DocumentFormat.OpenXml.Word2010.SaturationModulation
...
export class SaturationModulation extends OpenXmlLeafElement {
  override readonly localName = "satMod" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "SaturationModulation" });
  }
}

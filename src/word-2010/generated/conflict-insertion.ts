...
// @see DocumentFormat.OpenXml.Word2010.ConflictInsertion
...
export class ConflictInsertion extends OpenXmlLeafElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "ConflictInsertion" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "ConflictInsertion" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "ConflictInsertion" });
  }
}

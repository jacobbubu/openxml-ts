...
// @see DocumentFormat.OpenXml.Word2010.BevelBottom
...
export class BevelBottom extends OpenXmlLeafElement {
  override readonly localName = "bevelB" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w14:w": this.width = Int64Value.parse(value); assertNumber(this.width, { min: 0, max: 2147483647 }, { attribute: "w14:w", elementClass: "BevelBottom" }); return;
      case "w14:h": this.height = Int64Value.parse(value); assertNumber(this.height, { min: 0, max: 2147483647 }, { attribute: "w14:h", elementClass: "BevelBottom" }); return;

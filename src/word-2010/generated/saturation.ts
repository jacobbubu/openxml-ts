...
// @see DocumentFormat.OpenXml.Word2010.Saturation
...
export class Saturation extends OpenXmlLeafElement {
  override readonly localName = "sat" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w14:val", elementClass: "Saturation" });
  }
}

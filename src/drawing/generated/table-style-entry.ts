...
// @see DocumentFormat.OpenXml.Drawing.TableStyleEntry
...
export class TableStyleEntry extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.styleId, { attribute: ":styleId", elementClass: "TableStyleEntry" });
    assertRequired(this.styleName, { attribute: ":styleName", elementClass: "TableStyleEntry" });
  }
}

...
// @see DocumentFormat.OpenXml.Drawing.Outline
...
export class Outline extends OpenXmlCompositeElement {
  override readonly localName = "ln" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w": this.width = Int32Value.parse(value); assertNumber(this.width, { min: 0, max: 20116800 }, { attribute: ":w", elementClass: "Outline" }); return;

...
// @see DocumentFormat.OpenXml.Drawing.BiLevel
...
export class BiLevel extends OpenXmlLeafElement {
  override readonly localName = "biLevel" as const;
  ...
  validateRequired(): void {
    assertRequired(this.threshold, { attribute: ":thresh", elementClass: "BiLevel" });
  }
}

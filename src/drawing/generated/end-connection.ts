...
// @see DocumentFormat.OpenXml.Drawing.EndConnection
...
export class EndConnection extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "EndConnection" });
    assertRequired(this.index, { attribute: ":idx", elementClass: "EndConnection" });
  }
}

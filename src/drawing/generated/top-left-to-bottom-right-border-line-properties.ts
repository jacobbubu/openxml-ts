...
// @see DocumentFormat.OpenXml.Drawing.TopLeftToBottomRightBorderLineProperties
...
export class TopLeftToBottomRightBorderLineProperties extends OpenXmlCompositeElement {
  override readonly localName = "lnTlToBr" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w": this.width = Int32Value.parse(value); assertNumber(this.width, { min: 0, max: 20116800 }, { attribute: ":w", elementClass: "TopLeftToBottomRightBorderLineProperties" }); return;

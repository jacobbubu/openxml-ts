...
// @see DocumentFormat.OpenXml.Drawing.WaveAudioFile
...
/** Audio from WAV File.
 *
 * Element: `a:wavAudioFile` */
export class WaveAudioFile extends OpenXmlLeafElement {
  override readonly localName = "wavAudioFile" as const;
  ...
  validateRequired(): void {
    assertRequired(this.embed, { attribute: "r:embed", elementClass: "WaveAudioFile" });
  }
}

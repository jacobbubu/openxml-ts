...
// @see DocumentFormat.OpenXml.Drawing.OverrideColorMapping
 ...
 *
 * Element: `a:overrideClrMapping` */
export class OverrideColorMapping extends OpenXmlCompositeElement {
  override readonly localName = "overrideClrMapping" as const;
  ...
  validateRequired(): void {
    assertRequired(this.background1, { attribute: ":bg1", elementClass: "OverrideColorMapping" });
    assertRequired(this.text1, { attribute: ":tx1", elementClass: "OverrideColorMapping" });
    assertRequired(this.background2, { attribute: ":bg2", elementClass: "OverrideColorMapping" });
    assertRequired(this.text2, { attribute: ":tx2", elementClass: "OverrideColorMapping" });
    assertRequired(this.accent1, { attribute: ":accent1", elementClass: "OverrideColorMapping" });
    assertRequired(this.accent2, { attribute: ":accent2", elementClass: "OverrideColorMapping" });
    assertRequired(this.accent3, { attribute: ":accent3", elementClass: "OverrideColorMapping" });
    assertRequired(this.accent4, { attribute: ":accent4", elementClass: "OverrideColorMapping" });
    assertRequired(this.accent5, { attribute: ":accent5", elementClass: "OverrideColorMapping" });
    assertRequired(this.accent6, { attribute: ":accent6", elementClass: "OverrideColorMapping" });
    assertRequired(this.hyperlink, { attribute: ":hlink", elementClass: "OverrideColorMapping" });
    assertRequired(this.followedHyperlink, { attribute: ":folHlink", elementClass: "OverrideColorMapping" });
  }
}

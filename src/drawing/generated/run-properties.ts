...
// @see DocumentFormat.OpenXml.Drawing.RunProperties
...
export class RunProperties extends OpenXmlCompositeElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "sz": this.fontSize = Int32Value.parse(value); assertNumber(this.fontSize, { min: 100, max: 400000 }, { attribute: ":sz", elementClass: "RunProperties" }); return;
      ...
      case "kern": this.kerning = Int32Value.parse(value); assertNumber(this.kerning, { min: 0, max: 400000 }, { attribute: ":kern", elementClass: "RunProperties" }); return;
      case "cap": this.capital = StringValue.parse(value); return;
      case "spc": this.spacing = Int32Value.parse(value); assertNumber(this.spacing, { min: -400000, max: 400000 }, { attribute: ":spc", elementClass: "RunProperties" }); return;

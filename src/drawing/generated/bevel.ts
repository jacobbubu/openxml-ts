...
// @see DocumentFormat.OpenXml.Drawing.Bevel
...
export class Bevel extends OpenXmlLeafElement {
  override readonly localName = "bevel" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w": this.width = Int64Value.parse(value); assertNumber(this.width, { min: 0, max: 2147483647 }, { attribute: ":w", elementClass: "Bevel" }); return;
      case "h": this.height = Int64Value.parse(value); assertNumber(this.height, { min: 0, max: 2147483647 }, { attribute: ":h", elementClass: "Bevel" }); return;

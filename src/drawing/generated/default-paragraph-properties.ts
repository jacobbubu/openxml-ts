...
// @see DocumentFormat.OpenXml.Drawing.DefaultParagraphProperties
...
export class DefaultParagraphProperties extends OpenXmlCompositeElement {
  override readonly localName = "defPPr" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "marL": this.leftMargin = Int32Value.parse(value); assertNumber(this.leftMargin, { min: 0, max: 51206400 }, { attribute: ":marL", elementClass: "DefaultParagraphProperties" }); return;
      case "marR": this.rightMargin = Int32Value.parse(value); assertNumber(this.rightMargin, { min: 0, max: 51206400 }, { attribute: ":marR", elementClass: "DefaultParagraphProperties" }); return;
      case "lvl": this.level = Int32Value.parse(value); assertNumber(this.level, { min: 0, max: 8 }, { attribute: ":lvl", elementClass: "DefaultParagraphProperties" }); return;
      case "indent": this.indent = Int32Value.parse(value); assertNumber(this.indent, { min: -51206400, max: 51206400 }, { attribute: ":indent", elementClass: "DefaultParagraphProperties" }); return;

...
// @see DocumentFormat.OpenXml.Drawing.EndParagraphRunProperties
...
export class EndParagraphRunProperties extends OpenXmlCompositeElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "sz": this.fontSize = Int32Value.parse(value); assertNumber(this.fontSize, { min: 100, max: 400000 }, { attribute: ":sz", elementClass: "EndParagraphRunProperties" }); return;
      ...
      case "kern": this.kerning = Int32Value.parse(value); assertNumber(this.kerning, { min: 0, max: 400000 }, { attribute: ":kern", elementClass: "EndParagraphRunProperties" }); return;
      case "cap": this.capital = StringValue.parse(value); return;
      case "spc": this.spacing = Int32Value.parse(value); assertNumber(this.spacing, { min: -400000, max: 400000 }, { attribute: ":spc", elementClass: "EndParagraphRunProperties" }); return;

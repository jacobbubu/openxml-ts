...
// @see DocumentFormat.OpenXml.Drawing.ScaleY
...
export class ScaleY extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.numerator, { attribute: ":n", elementClass: "ScaleY" });
    assertRequired(this.denominator, { attribute: ":d", elementClass: "ScaleY" });
  }
}

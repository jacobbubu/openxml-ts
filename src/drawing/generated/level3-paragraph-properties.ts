...
// @see DocumentFormat.OpenXml.Drawing.Level3ParagraphProperties
...
export class Level3ParagraphProperties extends OpenXmlCompositeElement {
  override readonly localName = "lvl3pPr" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "marL": this.leftMargin = Int32Value.parse(value); assertNumber(this.leftMargin, { min: 0, max: 51206400 }, { attribute: ":marL", elementClass: "Level3ParagraphProperties" }); return;
      case "marR": this.rightMargin = Int32Value.parse(value); assertNumber(this.rightMargin, { min: 0, max: 51206400 }, { attribute: ":marR", elementClass: "Level3ParagraphProperties" }); return;
      case "lvl": this.level = Int32Value.parse(value); assertNumber(this.level, { min: 0, max: 8 }, { attribute: ":lvl", elementClass: "Level3ParagraphProperties" }); return;
      case "indent": this.indent = Int32Value.parse(value); assertNumber(this.indent, { min: -51206400, max: 51206400 }, { attribute: ":indent", elementClass: "Level3ParagraphProperties" }); return;

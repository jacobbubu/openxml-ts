...
// @see DocumentFormat.OpenXml.Drawing.Underline
...
export class Underline extends OpenXmlCompositeElement {
  override readonly localName = "uLn" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w": this.width = Int32Value.parse(value); assertNumber(this.width, { min: 0, max: 20116800 }, { attribute: ":w", elementClass: "Underline" }); return;

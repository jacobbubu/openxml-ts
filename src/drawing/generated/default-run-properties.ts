...
// @see DocumentFormat.OpenXml.Drawing.DefaultRunProperties
...
export class DefaultRunProperties extends OpenXmlCompositeElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "sz": this.fontSize = Int32Value.parse(value); assertNumber(this.fontSize, { min: 100, max: 400000 }, { attribute: ":sz", elementClass: "DefaultRunProperties" }); return;
      ...
      case "kern": this.kerning = Int32Value.parse(value); assertNumber(this.kerning, { min: 0, max: 400000 }, { attribute: ":kern", elementClass: "DefaultRunProperties" }); return;
      case "cap": this.capital = StringValue.parse(value); return;
      case "spc": this.spacing = Int32Value.parse(value); assertNumber(this.spacing, { min: -400000, max: 400000 }, { attribute: ":spc", elementClass: "DefaultRunProperties" }); return;

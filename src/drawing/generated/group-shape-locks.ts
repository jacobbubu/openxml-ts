...
// @see DocumentFormat.OpenXml.Drawing.GroupShapeLocks
 ...
 *
 * Element: `a:grpSpLocks` */
export class GroupShapeLocks extends OpenXmlCompositeElement {
  override readonly localName = "grpSpLocks" as const;
  ...
  /** Disallow Shape Ungrouping (:noUngrp) */
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.noUngrouping !== undefined) out.push([":noUngrp", this.noUngrouping.toString()]);

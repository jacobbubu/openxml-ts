...
// @see DocumentFormat.OpenXml.Spreadsheet.TotalsRowFormula
...
/** Totals Row Formula.
 *
 * Element: `x:totalsRowFormula` */
export class TotalsRowFormula extends OpenXmlLeafElement {
  override readonly localName = "totalsRowFormula" as const;

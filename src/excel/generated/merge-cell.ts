...
// @see DocumentFormat.OpenXml.Spreadsheet.MergeCell
...
export class MergeCell extends OpenXmlLeafElement {
  override readonly localName = "mergeCell" as const;
  ...
  validateRequired(): void {
    assertRequired(this.reference, { attribute: ":ref", elementClass: "MergeCell" });
  }
}

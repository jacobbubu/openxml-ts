...
// @see DocumentFormat.OpenXml.Spreadsheet.ForegroundColor
 ...
 *
 * Element: `x:fgColor` */
export class ForegroundColor extends OpenXmlLeafElement {
  override readonly localName = "fgColor" as const;

...
// @see DocumentFormat.OpenXml.Spreadsheet.DateTimeItem
 ...
 *
 * Element: `x:d` */
export class DateTimeItem extends OpenXmlCompositeElement {
  override readonly localName = "d" as const;
  override readonly prefix = "x" as const;
  override readonly namespaceUri = "http://schemas.openxmlformats.org/spreadsheetml/2006/main" as const;
  override readonly children: OpenXmlElementList = new OpenXmlElementList(this);

  /** Value (:v) */
  val: DateTimeValue | undefined;

  /** Unused Item (:u) */
  unused: BooleanValue | undefined;

  /** Calculated Item Value (:f) */
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case ":v": this.val = DateTimeValue.parse(value); return;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":v", elementClass: "DateTimeItem" });
  }
}

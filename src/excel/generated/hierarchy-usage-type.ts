...
// @see DocumentFormat.OpenXml.Spreadsheet.HierarchyUsageType
...
export abstract class HierarchyUsageType extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.value, { attribute: ":hierarchyUsage", elementClass: "HierarchyUsageType" });
  }
}

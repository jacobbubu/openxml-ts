...
// @see DocumentFormat.OpenXml.Spreadsheet.NumberItem
 ...
 *
 * Element: `x:n` */
export class NumberItem extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":v", elementClass: "NumberItem" });
  }
}

...
// @see DocumentFormat.OpenXml.Spreadsheet.DataFields
 ...
 *
 * Element: `x:dataFields` */
export class DataFields extends OpenXmlCompositeElement {
  override readonly localName = "dataFields" as const;

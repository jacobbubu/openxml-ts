...
// @see DocumentFormat.OpenXml.Spreadsheet.TableColumns
...
export class TableColumns extends OpenXmlCompositeElement {
  override readonly localName = "tableColumns" as const;

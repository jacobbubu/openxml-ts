...
// @see DocumentFormat.OpenXml.Spreadsheet.FieldItem
 ...
 *
 * Element: `x:x` */
export class FieldItem extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":v", elementClass: "FieldItem" });
  }
}

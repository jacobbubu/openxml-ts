...
// @see DocumentFormat.OpenXml.Spreadsheet.WorksheetSource
 ...
 *
 * Element: `x:worksheetSource` */
export class WorksheetSource extends OpenXmlLeafElement {
  override readonly localName = "worksheetSource" as const;

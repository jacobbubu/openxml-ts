...
// @see DocumentFormat.OpenXml.Spreadsheet.FontName
 ...
 *
 * Element: `x:name` */
export class FontName extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "FontName" });
  }
}

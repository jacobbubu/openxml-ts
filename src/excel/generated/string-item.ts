...
// @see DocumentFormat.OpenXml.Spreadsheet.StringItem
 ...
 *
 * Element: `x:s` */
export class StringItem extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":v", elementClass: "StringItem" });
  }
}

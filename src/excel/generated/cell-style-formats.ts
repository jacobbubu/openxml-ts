...
// @see DocumentFormat.OpenXml.Spreadsheet.CellStyleFormats
...
export class CellStyleFormats extends OpenXmlCompositeElement {
  override readonly localName = "cellStyleXfs" as const;

...
// @see DocumentFormat.OpenXml.Spreadsheet.OldFormula
...
/** Old Formula.
 *
 * Element: `x:oldFormula` */
export class OldFormula extends OpenXmlLeafElement {
  override readonly localName = "oldFormula" as const;

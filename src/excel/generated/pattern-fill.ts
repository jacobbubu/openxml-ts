...
// @see DocumentFormat.OpenXml.Spreadsheet.PatternFill
...
/** Pattern.
 *
 * Element: `x:patternFill` */
export class PatternFill extends OpenXmlCompositeElement {
  override readonly localName = "patternFill" as const;
  override readonly prefix = "x" as const;
  override readonly namespaceUri = "http://schemas.openxmlformats.org/spreadsheetml/2006/main" as const;
  override readonly children: OpenXmlElementList = new OpenXmlElementList(this);

  /** Pattern Type (:patternType) */
  patternType: StringValue | undefined;

...
// @see DocumentFormat.OpenXml.Diagram.StyleDisplayCategory
...
export class StyleDisplayCategory extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.type, { attribute: ":type", elementClass: "StyleDisplayCategory" });
    assertRequired(this.priority, { attribute: ":pri", elementClass: "StyleDisplayCategory" });
  }
}

...
// @see DocumentFormat.OpenXml.Diagram.Shape3D
...
export class Shape3D extends OpenXmlCompositeElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "z": this.z = Int64Value.parse(value); assertNumber(this.z, { min: -27273042329600, max: 27273042316900 }, { attribute: ":z", elementClass: "Shape3D" }); return;
      case "extrusionH": this.extrusionHeight = Int64Value.parse(value); assertNumber(this.extrusionHeight, { min: 0, max: 2147483647 }, { attribute: ":extrusionH", elementClass: "Shape3D" }); return;
      case "contourW": this.contourWidth = Int64Value.parse(value); assertNumber(this.contourWidth, { min: 0, max: 2147483647 }, { attribute: ":contourW", elementClass: "Shape3D" }); return;

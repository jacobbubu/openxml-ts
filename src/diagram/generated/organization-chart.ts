...
// @see DocumentFormat.OpenXml.Diagram.OrganizationChart
 ...
 *
 * Element: `dgm:orgChart` */
export class OrganizationChart extends OpenXmlLeafElement {
  override readonly localName = "orgChart" as const;
  ...
  /** Show Organization Chart User Interface Value (:val) */

...
// @see DocumentFormat.OpenXml.Diagram.ColorTransformCategory
...
export class ColorTransformCategory extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.type, { attribute: ":type", elementClass: "ColorTransformCategory" });
    assertRequired(this.priority, { attribute: ":pri", elementClass: "ColorTransformCategory" });
  }
}

...
// @see DocumentFormat.OpenXml.Diagram.Constraint
...
export class Constraint extends OpenXmlCompositeElement {
  override readonly localName = "constr" as const;
  ...
  /** Reference For (:refFor) */
  referenceFor: StringValue | undefined;

  /** Reference For Name (:refForName) */
  referenceForName: StringValue | undefined;

  /** Reference Point Type (:refPtType) */
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "refType": this.referenceType = StringValue.parse(value); return;
      case "refFor": this.referenceFor = StringValue.parse(value); return;
      case "refForName": this.referenceForName = StringValue.parse(value); return;
      case "refPtType": this.referencePointType = StringValue.parse(value); return;
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.referenceType !== undefined) out.push(["refType", this.referenceType.toString()]);
    if (this.referenceFor !== undefined) out.push(["refFor", this.referenceFor.toString()]);
    if (this.referenceForName !== undefined) out.push(["refForName", this.referenceForName.toString()]);
    if (this.referencePointType !== undefined) out.push(["refPtType", this.referencePointType.toString()]);
  ...
  validateRequired(): void {
    assertRequired(this.type, { attribute: ":type", elementClass: "Constraint" });
  }
}

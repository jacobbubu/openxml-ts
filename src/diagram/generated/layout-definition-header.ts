...
// @see DocumentFormat.OpenXml.Diagram.LayoutDefinitionHeader
 ...
 *
 * Element: `dgm:layoutDefHdr` */
export class LayoutDefinitionHeader extends OpenXmlCompositeElement {
  override readonly localName = "layoutDefHdr" as const;
  ...
  validateRequired(): void {
    assertRequired(this.uniqueId, { attribute: ":uniqueId", elementClass: "LayoutDefinitionHeader" });
  }
}

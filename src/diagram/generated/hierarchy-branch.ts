...
// @see DocumentFormat.OpenXml.Diagram.HierarchyBranch
 ...
 *
 * Element: `dgm:hierBranch` */
export class HierarchyBranch extends OpenXmlLeafElement {
  override readonly localName = "hierBranch" as const;
  ...
  /** Organization Chart Branch Style Value (:val) */

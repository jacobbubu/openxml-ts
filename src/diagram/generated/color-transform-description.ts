...
// @see DocumentFormat.OpenXml.Diagram.ColorTransformDescription
...
export class ColorTransformDescription extends OpenXmlLeafElement {
  override readonly localName = "desc" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "ColorTransformDescription" });
  }
}

...
// @see DocumentFormat.OpenXml.Diagram.StyleDefinitionHeader
 ...
 *
 * Element: `dgm:styleDefHdr` */
export class StyleDefinitionHeader extends OpenXmlCompositeElement {
  override readonly localName = "styleDefHdr" as const;
  ...
  validateRequired(): void {
    assertRequired(this.uniqueId, { attribute: ":uniqueId", elementClass: "StyleDefinitionHeader" });
  }
}

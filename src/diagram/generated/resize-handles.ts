...
// @see DocumentFormat.OpenXml.Diagram.ResizeHandles
...
/** Shape Resize Style.
 *
 * Element: `dgm:resizeHandles` */
export class ResizeHandles extends OpenXmlLeafElement {
  override readonly localName = "resizeHandles" as const;

/**
 * `ThemeOverridePart` — generated from Open-XML-SDK part definition.
 * Faithful port of DocumentFormat.OpenXml.Packaging.ThemeOverridePart.
 *
...
export class ThemeOverridePart extends TypedXmlPart<OpenXmlUnknownElement> {
  ...
  constructor(part: IPackagePart, registry: ElementRegistry) {
    super(part, registry, ThemeOverridePartRoot);
  }
}

class ThemeOverridePartRoot extends OpenXmlUnknownElement {
  constructor() {
    super("", "root", "");
  }
}

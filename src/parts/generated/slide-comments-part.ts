...
export class SlideCommentsPart extends TypedXmlPart<OpenXmlUnknownElement> {
  ...
  constructor(part: IPackagePart, registry: ElementRegistry) {
    super(part, registry, SlideCommentsPartRoot);
  }
}

class SlideCommentsPartRoot extends OpenXmlUnknownElement {
  constructor() {
    super("", "root", "");
  }
}

/**
 * `StylesWithEffectsPart` — generated from Open-XML-SDK part definition.
 * Faithful port of DocumentFormat.OpenXml.Packaging.StylesWithEffectsPart.
 *
...
export class StylesWithEffectsPart extends TypedXmlPart<OpenXmlUnknownElement> {
  ...
  constructor(part: IPackagePart, registry: ElementRegistry) {
    super(part, registry, StylesWithEffectsPartRoot);
  }
}

class StylesWithEffectsPartRoot extends OpenXmlUnknownElement {
  constructor() {
    super("", "root", "");
  }
}

/**
 * `SlideSyncDataPart` — generated from Open-XML-SDK part definition.
 * Faithful port of DocumentFormat.OpenXml.Packaging.SlideSyncDataPart.
 *
...
export class SlideSyncDataPart extends TypedXmlPart<OpenXmlUnknownElement> {
  ...
  constructor(part: IPackagePart, registry: ElementRegistry) {
    super(part, registry, SlideSyncDataPartRoot);
  }
}

class SlideSyncDataPartRoot extends OpenXmlUnknownElement {
  constructor() {
    super("", "root", "");
  }
}

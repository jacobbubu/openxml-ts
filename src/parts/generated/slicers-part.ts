...
export class SlicersPart extends TypedXmlPart<OpenXmlUnknownElement> {
  ...
  constructor(part: IPackagePart, registry: ElementRegistry) {
    super(part, registry, SlicersPartRoot);
  }
}

class SlicersPartRoot extends OpenXmlUnknownElement {
  constructor() {
    super("", "root", "");
  }
}

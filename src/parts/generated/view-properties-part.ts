/**
 * `ViewPropertiesPart` — generated from Open-XML-SDK part definition.
 * Faithful port of DocumentFormat.OpenXml.Packaging.ViewPropertiesPart.
 *
...
export class ViewPropertiesPart extends TypedXmlPart<OpenXmlUnknownElement> {
  ...
  constructor(part: IPackagePart, registry: ElementRegistry) {
    super(part, registry, ViewPropertiesPartRoot);
  }
}

class ViewPropertiesPartRoot extends OpenXmlUnknownElement {
  constructor() {
    super("", "root", "");
  }
}

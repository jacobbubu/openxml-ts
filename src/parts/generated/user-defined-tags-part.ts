/**
 * `UserDefinedTagsPart` — generated from Open-XML-SDK part definition.
 * Faithful port of DocumentFormat.OpenXml.Packaging.UserDefinedTagsPart.
 *
...
export class UserDefinedTagsPart extends TypedXmlPart<OpenXmlUnknownElement> {
  ...
  constructor(part: IPackagePart, registry: ElementRegistry) {
    super(part, registry, UserDefinedTagsPartRoot);
  }
}

class UserDefinedTagsPartRoot extends OpenXmlUnknownElement {
  constructor() {
    super("", "root", "");
  }
}

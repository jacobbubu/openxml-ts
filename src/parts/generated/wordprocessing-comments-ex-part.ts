/**
 * `WordprocessingCommentsExPart` — generated from Open-XML-SDK part definition.
 * Faithful port of DocumentFormat.OpenXml.Packaging.WordprocessingCommentsExPart.
 *
...
export class WordprocessingCommentsExPart extends TypedXmlPart<OpenXmlUnknownElement> {
  ...
  constructor(part: IPackagePart, registry: ElementRegistry) {
    super(part, registry, WordprocessingCommentsExPartRoot);
  }
}

class WordprocessingCommentsExPartRoot extends OpenXmlUnknownElement {
  constructor() {
    super("", "root", "");
  }
}

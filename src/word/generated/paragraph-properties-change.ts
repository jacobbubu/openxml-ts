...
// @see DocumentFormat.OpenXml.Wordprocessing.ParagraphPropertiesChange
 ...
 *
 * Element: `w:pPrChange` */
export class ParagraphPropertiesChange extends OpenXmlCompositeElement {
  override readonly localName = "pPrChange" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "ParagraphPropertiesChange" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "ParagraphPropertiesChange" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "ParagraphPropertiesChange" });
  }
}

...
// @see DocumentFormat.OpenXml.Wordprocessing.MoveFrom
 ...
 *
 * Element: `w:moveFrom` */
export class MoveFrom extends OpenXmlLeafElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "MoveFrom" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "MoveFrom" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "MoveFrom" });
  }
}

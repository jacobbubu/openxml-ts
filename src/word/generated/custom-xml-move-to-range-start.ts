...
// @see DocumentFormat.OpenXml.Wordprocessing.CustomXmlMoveToRangeStart
 ...
 *
 * Element: `w:customXmlMoveToRangeStart` */
export class CustomXmlMoveToRangeStart extends OpenXmlLeafElement {
  override readonly localName = "customXmlMoveToRangeStart" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "CustomXmlMoveToRangeStart" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "CustomXmlMoveToRangeStart" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "CustomXmlMoveToRangeStart" });
  }
}

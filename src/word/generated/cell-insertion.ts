...
// @see DocumentFormat.OpenXml.Wordprocessing.CellInsertion
 ...
 *
 * Element: `w:cellIns` */
export class CellInsertion extends OpenXmlLeafElement {
  override readonly localName = "cellIns" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "CellInsertion" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "CellInsertion" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "CellInsertion" });
  }
}

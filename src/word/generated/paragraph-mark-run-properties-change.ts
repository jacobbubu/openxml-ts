...
// @see DocumentFormat.OpenXml.Wordprocessing.ParagraphMarkRunPropertiesChange
 ...
 *
 * Element: `w:rPrChange` */
export class ParagraphMarkRunPropertiesChange extends OpenXmlCompositeElement {
  override readonly localName = "rPrChange" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "ParagraphMarkRunPropertiesChange" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "ParagraphMarkRunPropertiesChange" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "ParagraphMarkRunPropertiesChange" });
  }
}

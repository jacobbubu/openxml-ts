...
// @see DocumentFormat.OpenXml.Wordprocessing.FootnoteReference
...
export class FootnoteReference extends OpenXmlLeafElement {
  override readonly localName = "footnoteReference" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "w:id", elementClass: "FootnoteReference" });
  }
}

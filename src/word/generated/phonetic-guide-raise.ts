...
// @see DocumentFormat.OpenXml.Wordprocessing.PhoneticGuideRaise
 ...
 *
 * Element: `w:hpsRaise` */
export class PhoneticGuideRaise extends OpenXmlLeafElement {
  override readonly localName = "hpsRaise" as const;

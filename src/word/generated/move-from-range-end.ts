...
// @see DocumentFormat.OpenXml.Wordprocessing.MoveFromRangeEnd
 ...
 *
 * Element: `w:moveFromRangeEnd` */
export class MoveFromRangeEnd extends OpenXmlLeafElement {
  override readonly localName = "moveFromRangeEnd" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "w:id", elementClass: "MoveFromRangeEnd" });
  }
}

...
// @see DocumentFormat.OpenXml.Wordprocessing.FooterReference
...
export class FooterReference extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.type, { attribute: "w:type", elementClass: "FooterReference" });
    assertRequired(this.id, { attribute: "r:id", elementClass: "FooterReference" });
  }
}

...
// @see DocumentFormat.OpenXml.Wordprocessing.SectionPropertiesChange
 ...
 *
 * Element: `w:sectPrChange` */
export class SectionPropertiesChange extends OpenXmlCompositeElement {
  override readonly localName = "sectPrChange" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "SectionPropertiesChange" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "SectionPropertiesChange" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "SectionPropertiesChange" });
  }
}

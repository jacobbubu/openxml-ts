...
// @see DocumentFormat.OpenXml.Wordprocessing.TableCellSpacing
 ...
 *
 * Element: `w:tblCellSpacing` */
export class TableCellSpacing extends OpenXmlLeafElement {
  override readonly localName = "tblCellSpacing" as const;

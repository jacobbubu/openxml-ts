...
// @see DocumentFormat.OpenXml.Wordprocessing.TableCellPropertiesChange
 ...
 *
 * Element: `w:tcPrChange` */
export class TableCellPropertiesChange extends OpenXmlCompositeElement {
  override readonly localName = "tcPrChange" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "TableCellPropertiesChange" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "TableCellPropertiesChange" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "TableCellPropertiesChange" });
  }
}

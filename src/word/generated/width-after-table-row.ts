...
// @see DocumentFormat.OpenXml.Wordprocessing.WidthAfterTableRow
 ...
 *
 * Element: `w:wAfter` */
export class WidthAfterTableRow extends OpenXmlLeafElement {
  override readonly localName = "wAfter" as const;

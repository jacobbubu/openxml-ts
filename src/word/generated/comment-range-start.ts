...
// @see DocumentFormat.OpenXml.Wordprocessing.CommentRangeStart
...
export class CommentRangeStart extends OpenXmlLeafElement {
  override readonly localName = "commentRangeStart" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "w:id", elementClass: "CommentRangeStart" });
  }
}

...
// @see DocumentFormat.OpenXml.Wordprocessing.NumberingChange
 ...
 *
 * Element: `w:numberingChange` */
export class NumberingChange extends OpenXmlLeafElement {
  override readonly localName = "numberingChange" as const;
  override readonly prefix = "w" as const;
  override readonly namespaceUri = "http://schemas.openxmlformats.org/wordprocessingml/2006/main" as const;


  /** original (w:original) */
  original: StringValue | undefined;
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.original !== undefined) out.push(["w:original", this.original.toString()]);

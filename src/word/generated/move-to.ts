...
// @see DocumentFormat.OpenXml.Wordprocessing.MoveTo
 ...
 *
 * Element: `w:moveTo` */
export class MoveTo extends OpenXmlLeafElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "MoveTo" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "MoveTo" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "MoveTo" });
  }
}

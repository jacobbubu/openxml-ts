...
export class CellMerge extends OpenXmlLeafElement {
  ...
  /** vMerge (w:vMerge) */
  verticalMerge: StringValue | undefined;

  /** vMergeOrig (w:vMergeOrig) */
  verticalMergeOriginal: StringValue | undefined;
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.verticalMerge !== undefined) out.push(["w:vMerge", this.verticalMerge.toString()]);
    if (this.verticalMergeOriginal !== undefined) out.push(["w:vMergeOrig", this.verticalMergeOriginal.toString()]);

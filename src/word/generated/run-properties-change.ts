...
// @see DocumentFormat.OpenXml.Wordprocessing.RunPropertiesChange
 ...
 *
 * Element: `w:rPrChange` */
export class RunPropertiesChange extends OpenXmlCompositeElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "RunPropertiesChange" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "RunPropertiesChange" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "RunPropertiesChange" });
  }
}

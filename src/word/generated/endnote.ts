...
// @see DocumentFormat.OpenXml.Wordprocessing.Endnote
 ...
 *
 * Element: `w:endnote` */
export class Endnote extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "w:id", elementClass: "Endnote" });
  }
}

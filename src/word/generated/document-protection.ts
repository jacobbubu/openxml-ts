...
// @see DocumentFormat.OpenXml.Wordprocessing.DocumentProtection
 ...
 *
 * Element: `w:documentProtection` */
export class DocumentProtection extends OpenXmlLeafElement {
  override readonly localName = "documentProtection" as const;
  override readonly prefix = "w" as const;
  override readonly namespaceUri = "http://schemas.openxmlformats.org/wordprocessingml/2006/main" as const;


  /** Document Editing Restrictions (w:edit) */
  edit: StringValue | undefined;

  /** Only Allow Formatting With Unlocked Styles (w:formatting) */
  formatting: BooleanValue | undefined;

  /** Enforce Document Protection Settings (w:enforcement) */
  enforcement: BooleanValue | undefined;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:edit": this.edit = StringValue.parse(value); return;
      case "w:formatting": this.formatting = BooleanValue.parse(value); return;
      case "w:enforcement": this.enforcement = BooleanValue.parse(value); return;
      ...
      case "w:cryptSpinCount": this.cryptographicSpinCount = UInt32Value.parse(value); assertNumber(this.cryptographicSpinCount, { max: 5000000 }, { attribute: "w:cryptSpinCount", elementClass: "DocumentProtection" }); return;
  ...
  protected override collectAttributes(): Array<[string, string]> {
    ...
    if (this.edit !== undefined) out.push(["w:edit", this.edit.toString()]);
    if (this.formatting !== undefined) out.push(["w:formatting", this.formatting.toString()]);
    if (this.enforcement !== undefined) out.push(["w:enforcement", this.enforcement.toString()]);

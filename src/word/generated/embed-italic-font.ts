...
// @see DocumentFormat.OpenXml.Wordprocessing.EmbedItalicFont
 ...
 *
 * Element: `w:embedItalic` */
export class EmbedItalicFont extends OpenXmlLeafElement {
  override readonly localName = "embedItalic" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "r:id", elementClass: "EmbedItalicFont" });
  }
}

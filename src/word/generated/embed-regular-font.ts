...
// @see DocumentFormat.OpenXml.Wordprocessing.EmbedRegularFont
...
export class EmbedRegularFont extends OpenXmlLeafElement {
  override readonly localName = "embedRegular" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "r:id", elementClass: "EmbedRegularFont" });
  }
}

...
// @see DocumentFormat.OpenXml.Wordprocessing.MoveFromRun
 ...
 *
 * Element: `w:moveFrom` */
export class MoveFromRun extends OpenXmlCompositeElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "MoveFromRun" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "MoveFromRun" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "MoveFromRun" });
  }
}

...
// @see DocumentFormat.OpenXml.Wordprocessing.MoveToRangeEnd
 ...
 *
 * Element: `w:moveToRangeEnd` */
export class MoveToRangeEnd extends OpenXmlLeafElement {
  override readonly localName = "moveToRangeEnd" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "w:id", elementClass: "MoveToRangeEnd" });
  }
}

...
// @see DocumentFormat.OpenXml.Wordprocessing.CustomXmlInsRangeStart
 ...
 *
 * Element: `w:customXmlInsRangeStart` */
export class CustomXmlInsRangeStart extends OpenXmlLeafElement {
  override readonly localName = "customXmlInsRangeStart" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "CustomXmlInsRangeStart" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "CustomXmlInsRangeStart" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "CustomXmlInsRangeStart" });
  }
}

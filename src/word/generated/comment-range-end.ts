...
// @see DocumentFormat.OpenXml.Wordprocessing.CommentRangeEnd
...
export class CommentRangeEnd extends OpenXmlLeafElement {
  override readonly localName = "commentRangeEnd" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "w:id", elementClass: "CommentRangeEnd" });
  }
}

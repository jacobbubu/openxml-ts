...
// @see DocumentFormat.OpenXml.Wordprocessing.CustomXmlMoveFromRangeStart
 ...
 *
 * Element: `w:customXmlMoveFromRangeStart` */
export class CustomXmlMoveFromRangeStart extends OpenXmlLeafElement {
  override readonly localName = "customXmlMoveFromRangeStart" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "CustomXmlMoveFromRangeStart" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "CustomXmlMoveFromRangeStart" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "CustomXmlMoveFromRangeStart" });
  }
}

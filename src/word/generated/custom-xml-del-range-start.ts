...
// @see DocumentFormat.OpenXml.Wordprocessing.CustomXmlDelRangeStart
 ...
 *
 * Element: `w:customXmlDelRangeStart` */
export class CustomXmlDelRangeStart extends OpenXmlLeafElement {
  override readonly localName = "customXmlDelRangeStart" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "CustomXmlDelRangeStart" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "CustomXmlDelRangeStart" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "CustomXmlDelRangeStart" });
  }
}

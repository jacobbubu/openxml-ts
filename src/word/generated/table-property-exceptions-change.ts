...
// @see DocumentFormat.OpenXml.Wordprocessing.TablePropertyExceptionsChange
 ...
 *
 * Element: `w:tblPrExChange` */
export class TablePropertyExceptionsChange extends OpenXmlCompositeElement {
  override readonly localName = "tblPrExChange" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "TablePropertyExceptionsChange" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "TablePropertyExceptionsChange" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "TablePropertyExceptionsChange" });
  }
}

...
// @see DocumentFormat.OpenXml.Wordprocessing.TemplateCode
 ...
 *
 * Element: `w:tmpl` */
export class TemplateCode extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w:val", elementClass: "TemplateCode" });
  }
}

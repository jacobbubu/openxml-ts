...
// @see DocumentFormat.OpenXml.Wordprocessing.DeletedRun
...
export class DeletedRun extends OpenXmlCompositeElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "w:author": this.author = StringValue.parse(value); assertString(this.author, { maxLength: 255 }, { attribute: "w:author", elementClass: "DeletedRun" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.author, { attribute: "w:author", elementClass: "DeletedRun" });
    assertRequired(this.id, { attribute: "w:id", elementClass: "DeletedRun" });
  }
}

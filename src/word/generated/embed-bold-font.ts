...
// @see DocumentFormat.OpenXml.Wordprocessing.EmbedBoldFont
 ...
 *
 * Element: `w:embedBold` */
export class EmbedBoldFont extends OpenXmlLeafElement {
  override readonly localName = "embedBold" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "r:id", elementClass: "EmbedBoldFont" });
  }
}

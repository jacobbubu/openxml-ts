...
// @see DocumentFormat.OpenXml.20188Main.CommentReplyList
 ...
 *
 * Element: `p188:replyLst` */
export class CommentReplyList extends OpenXmlCompositeElement {
  override readonly localName = "replyLst" as const;

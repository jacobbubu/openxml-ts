...
// @see DocumentFormat.OpenXml.Word2006Wordml.AllocatedCommands
 ...
 *
 * Element: `wne:acds` */
export class AllocatedCommands extends OpenXmlCompositeElement {
  override readonly localName = "acds" as const;

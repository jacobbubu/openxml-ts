...
// @see DocumentFormat.OpenXml.Word2006Wordml.TemplateCommandGroup
 ...
 *
 * Element: `wne:tcg` */
export class TemplateCommandGroup extends OpenXmlCompositeElement {
  override readonly localName = "tcg" as const;

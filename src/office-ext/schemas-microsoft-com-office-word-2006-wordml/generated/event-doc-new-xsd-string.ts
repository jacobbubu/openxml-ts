...
// @see DocumentFormat.OpenXml.Word2006Wordml.EventDocNewXsdString
 ...
 *
 * Element: `wne:eventDocNew` */
export class EventDocNewXsdString extends OpenXmlLeafElement {
  override readonly localName = "eventDocNew" as const;

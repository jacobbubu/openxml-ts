...
// @see DocumentFormat.OpenXml.Word2006Wordml.EventDocCloseXsdString
 ...
 *
 * Element: `wne:eventDocClose` */
export class EventDocCloseXsdString extends OpenXmlLeafElement {
  override readonly localName = "eventDocClose" as const;

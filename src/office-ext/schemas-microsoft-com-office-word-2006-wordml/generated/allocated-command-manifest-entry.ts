...
// @see DocumentFormat.OpenXml.Word2006Wordml.AllocatedCommandManifestEntry
 ...
 *
 * Element: `wne:acdEntry` */
export class AllocatedCommandManifestEntry extends OpenXmlLeafElement {
  override readonly localName = "acdEntry" as const;

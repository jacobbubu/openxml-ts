...
// @see DocumentFormat.OpenXml.Word2006Wordml.AllocatedCommandManifest
 ...
 *
 * Element: `wne:acdManifest` */
export class AllocatedCommandManifest extends OpenXmlCompositeElement {
  override readonly localName = "acdManifest" as const;

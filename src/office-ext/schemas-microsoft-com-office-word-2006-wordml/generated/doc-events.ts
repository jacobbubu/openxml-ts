...
// @see DocumentFormat.OpenXml.Word2006Wordml.DocEvents
 ...
 *
 * Element: `wne:docEvents` */
export class DocEvents extends OpenXmlCompositeElement {
  override readonly localName = "docEvents" as const;

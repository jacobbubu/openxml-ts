...
// @see DocumentFormat.OpenXml.Word2006Wordml.WllMacroKeyboardCustomization
 ...
 *
 * Element: `wne:wll` */
export class WllMacroKeyboardCustomization extends OpenXmlLeafElement {
  override readonly localName = "wll" as const;

...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata2.SupportingPropertyBagArray
 ...
 *
 * Element: `xlrd2:a` */
export class SupportingPropertyBagArray extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.count, { attribute: ":count", elementClass: "SupportingPropertyBagArray" });
  }
}

...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata2.SupportingPropertyBag
 ...
 *
 * Element: `xlrd2:spb` */
export class SupportingPropertyBag extends OpenXmlCompositeElement {
  override readonly localName = "spb" as const;
  ...
  validateRequired(): void {
    assertRequired(this.s, { attribute: ":s", elementClass: "SupportingPropertyBag" });
  }
}

...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata2.RichStylesheet
 ...
 *
 * Element: `xlrd2:richStyleSheet` */
export class RichStylesheet extends OpenXmlCompositeElement {
  override readonly localName = "richStyleSheet" as const;

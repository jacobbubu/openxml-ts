...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata2.RichFormatProperties
 ...
 *
 * Element: `xlrd2:richProperties` */
export class RichFormatProperties extends OpenXmlCompositeElement {
  override readonly localName = "richProperties" as const;

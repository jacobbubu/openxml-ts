...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata2.ArrayData
 ...
 *
 * Element: `xlrd2:arrayData` */
export class ArrayData extends OpenXmlCompositeElement {
  override readonly localName = "arrayData" as const;
  ...
  validateRequired(): void {
    assertRequired(this.count, { attribute: ":count", elementClass: "ArrayData" });
  }
}

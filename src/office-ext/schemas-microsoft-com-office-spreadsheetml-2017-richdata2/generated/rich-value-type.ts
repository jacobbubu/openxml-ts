...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata2.RichValueType
 ...
 *
 * Element: `xlrd2:type` */
export class RichValueType extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.name, { attribute: ":name", elementClass: "RichValueType" });
  }
}

...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata2.SupportingPropertyBagStructures
 ...
 *
 * Element: `xlrd2:spbStructures` */
export class SupportingPropertyBagStructures extends OpenXmlCompositeElement {
  override readonly localName = "spbStructures" as const;
  ...
  validateRequired(): void {
    assertRequired(this.count, { attribute: ":count", elementClass: "SupportingPropertyBagStructures" });
  }
}

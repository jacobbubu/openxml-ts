...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata2.RichValueTypeKeyFlags
 ...
 *
 * Element: `xlrd2:keyFlags` */
export class RichValueTypeKeyFlags extends OpenXmlCompositeElement {
  override readonly localName = "keyFlags" as const;

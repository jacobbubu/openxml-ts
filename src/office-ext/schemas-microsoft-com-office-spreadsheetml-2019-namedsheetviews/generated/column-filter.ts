...
// @see DocumentFormat.OpenXml.Spreadsheetml2019Namedsheetviews.ColumnFilter
 ...
 *
 * Element: `xnsv:columnFilter` */
export class ColumnFilter extends OpenXmlCompositeElement {
  override readonly localName = "columnFilter" as const;

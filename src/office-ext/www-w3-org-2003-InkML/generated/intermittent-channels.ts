...
// @see DocumentFormat.OpenXml.2003InkML.IntermittentChannels
 ...
 *
 * Element: `inkml:intermittentChannels` */
export class IntermittentChannels extends OpenXmlCompositeElement {
  override readonly localName = "intermittentChannels" as const;

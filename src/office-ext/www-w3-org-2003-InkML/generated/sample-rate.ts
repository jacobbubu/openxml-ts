...
// @see DocumentFormat.OpenXml.2003InkML.SampleRate
 ...
 *
 * Element: `inkml:sampleRate` */
export class SampleRate extends OpenXmlLeafElement {
  override readonly localName = "sampleRate" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "uniform": this.uniform = BooleanValue.parse(value); return;
  ...
  validateRequired(): void {
    assertRequired(this.value, { attribute: ":value", elementClass: "SampleRate" });
  }
}

...
// @see DocumentFormat.OpenXml.Ppt2013Command.MainMasterMonikerList
 ...
 *
 * Element: `pc:sldMasterMkLst` */
export class MainMasterMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "sldMasterMkLst" as const;

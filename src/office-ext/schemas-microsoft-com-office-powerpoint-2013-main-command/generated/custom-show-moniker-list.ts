...
// @see DocumentFormat.OpenXml.Ppt2013Command.CustomShowMonikerList
 ...
 *
 * Element: `pc:custShowMkLst` */
export class CustomShowMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "custShowMkLst" as const;

...
// @see DocumentFormat.OpenXml.Ppt2013Command.CommentAuthorMonikerList
 ...
 *
 * Element: `pc:cmAuthorMkLst` */
export class CommentAuthorMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "cmAuthorMkLst" as const;

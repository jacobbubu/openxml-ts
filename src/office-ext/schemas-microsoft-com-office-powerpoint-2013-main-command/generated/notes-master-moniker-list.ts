...
// @see DocumentFormat.OpenXml.Ppt2013Command.NotesMasterMonikerList
 ...
 *
 * Element: `pc:notesMasterMkLst` */
export class NotesMasterMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "notesMasterMkLst" as const;

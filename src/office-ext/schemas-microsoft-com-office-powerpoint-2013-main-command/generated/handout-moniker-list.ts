...
// @see DocumentFormat.OpenXml.Ppt2013Command.HandoutMonikerList
 ...
 *
 * Element: `pc:handoutMkLst` */
export class HandoutMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "handoutMkLst" as const;

...
// @see DocumentFormat.OpenXml.Ppt2013Command.NotesTextMonikerList
 ...
 *
 * Element: `pc:notesTxtMkLst` */
export class NotesTextMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "notesTxtMkLst" as const;

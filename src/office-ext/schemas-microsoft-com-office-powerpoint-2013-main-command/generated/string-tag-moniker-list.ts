...
// @see DocumentFormat.OpenXml.Ppt2013Command.StringTagMonikerList
 ...
 *
 * Element: `pc:tagMkLst` */
export class StringTagMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "tagMkLst" as const;

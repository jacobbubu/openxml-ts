...
// @see DocumentFormat.OpenXml.Ppt2013Command.DocumentMonikerList
 ...
 *
 * Element: `pc:docMkLst` */
export class DocumentMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "docMkLst" as const;

...
// @see DocumentFormat.OpenXml.Ppt2013Command.CustomXmlPartMonikerList
 ...
 *
 * Element: `pc:cXmlMkLst` */
export class CustomXmlPartMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "cXmlMkLst" as const;

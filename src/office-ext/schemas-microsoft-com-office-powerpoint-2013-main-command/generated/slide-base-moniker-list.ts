...
// @see DocumentFormat.OpenXml.Ppt2013Command.SlideBaseMonikerList
 ...
 *
 * Element: `pc:sldBaseMkLst` */
export class SlideBaseMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "sldBaseMkLst" as const;

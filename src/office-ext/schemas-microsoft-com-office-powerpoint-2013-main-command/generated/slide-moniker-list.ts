...
// @see DocumentFormat.OpenXml.Ppt2013Command.SlideMonikerList
 ...
 *
 * Element: `pc:sldMkLst` */
export class SlideMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "sldMkLst" as const;

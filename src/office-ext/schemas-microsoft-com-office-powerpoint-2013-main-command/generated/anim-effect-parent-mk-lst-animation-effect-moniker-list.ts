...
// @see DocumentFormat.OpenXml.Ppt2013Command.AnimEffectParentMkLstAnimationEffectMonikerList
 ...
 *
 * Element: `pc:animEffectParentMkLst` */
export class AnimEffectParentMkLstAnimationEffectMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "animEffectParentMkLst" as const;

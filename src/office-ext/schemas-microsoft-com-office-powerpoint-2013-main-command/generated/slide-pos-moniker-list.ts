...
// @see DocumentFormat.OpenXml.Ppt2013Command.SlidePosMonikerList
 ...
 *
 * Element: `pc:sldPosMkLst` */
export class SlidePosMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "sldPosMkLst" as const;

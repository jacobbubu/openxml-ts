...
// @see DocumentFormat.OpenXml.Ppt2013Command.SectionMonikerList
 ...
 *
 * Element: `pc:sectionMkLst` */
export class SectionMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "sectionMkLst" as const;

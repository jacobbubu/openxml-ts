...
// @see DocumentFormat.OpenXml.Ppt2013Command.CommentMonikerList
 ...
 *
 * Element: `pc:cmMkLst` */
export class CommentMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "cmMkLst" as const;

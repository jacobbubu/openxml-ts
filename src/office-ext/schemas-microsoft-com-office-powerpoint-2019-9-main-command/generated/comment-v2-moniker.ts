...
// @see DocumentFormat.OpenXml.9MainCommand.CommentV2Moniker
 ...
 *
 * Element: `pc2:cmMK` */
export class CommentV2Moniker extends OpenXmlLeafElement {
  override readonly localName = "cmMK" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "CommentV2Moniker" });
  }
}

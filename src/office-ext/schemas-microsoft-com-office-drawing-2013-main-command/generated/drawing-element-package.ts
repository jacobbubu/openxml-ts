...
// @see DocumentFormat.OpenXml.Drawing2013Command.DrawingElementPackage
 ...
 *
 * Element: `oac:dePkg` */
export class DrawingElementPackage extends OpenXmlLeafElement {
  override readonly localName = "dePkg" as const;

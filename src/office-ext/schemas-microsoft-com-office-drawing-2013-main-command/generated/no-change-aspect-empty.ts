...
// @see DocumentFormat.OpenXml.Drawing2013Command.NoChangeAspectEmpty
 ...
 *
 * Element: `oac:noChangeAspect` */
export class NoChangeAspectEmpty extends OpenXmlLeafElement {
  override readonly localName = "noChangeAspect" as const;

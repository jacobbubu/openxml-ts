...
// @see DocumentFormat.OpenXml.Drawing2013Command.DeMkLstDrawingElementMonikerList
 ...
 *
 * Element: `oac:deMkLst` */
export class DeMkLstDrawingElementMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "deMkLst" as const;

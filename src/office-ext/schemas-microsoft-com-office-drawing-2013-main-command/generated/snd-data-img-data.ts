...
// @see DocumentFormat.OpenXml.Drawing2013Command.SndDataImgData
 ...
 *
 * Element: `oac:sndData` */
export class SndDataImgData extends OpenXmlLeafElement {
  override readonly localName = "sndData" as const;

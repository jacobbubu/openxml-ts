...
// @see DocumentFormat.OpenXml.Drawing2013Command.ResetXsdboolean
 ...
 *
 * Element: `oac:reset` */
export class ResetXsdboolean extends OpenXmlLeafElement {
  override readonly localName = "reset" as const;

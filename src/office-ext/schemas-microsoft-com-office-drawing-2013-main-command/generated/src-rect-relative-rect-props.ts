...
// @see DocumentFormat.OpenXml.Drawing2013Command.SrcRectRelativeRectProps
 ...
 *
 * Element: `oac:srcRect` */
export class SrcRectRelativeRectProps extends OpenXmlLeafElement {
  override readonly localName = "srcRect" as const;

...
// @see DocumentFormat.OpenXml.Drawing2013Command.LnRefStyleMatrixReference
 ...
 *
 * Element: `oac:lnRef` */
export class LnRefStyleMatrixReference extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.index, { attribute: ":idx", elementClass: "LnRefStyleMatrixReference" });
  }
}

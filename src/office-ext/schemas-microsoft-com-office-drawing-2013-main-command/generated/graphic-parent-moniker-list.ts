...
// @see DocumentFormat.OpenXml.Drawing2013Command.GraphicParentMonikerList
 ...
 *
 * Element: `oac:graphicParentMkLst` */
export class GraphicParentMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "graphicParentMkLst" as const;

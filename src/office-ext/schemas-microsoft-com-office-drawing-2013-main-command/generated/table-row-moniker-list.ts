...
// @see DocumentFormat.OpenXml.Drawing2013Command.TableRowMonikerList
 ...
 *
 * Element: `oac:trMkLst` */
export class TableRowMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "trMkLst" as const;

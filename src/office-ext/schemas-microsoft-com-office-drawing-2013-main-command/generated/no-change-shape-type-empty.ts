...
// @see DocumentFormat.OpenXml.Drawing2013Command.NoChangeShapeTypeEmpty
 ...
 *
 * Element: `oac:noChangeShapeType` */
export class NoChangeShapeTypeEmpty extends OpenXmlLeafElement {
  override readonly localName = "noChangeShapeType" as const;

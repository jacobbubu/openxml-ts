...
// @see DocumentFormat.OpenXml.Drawing2013Command.TextBodyMonikerList
 ...
 *
 * Element: `oac:txBodyMkLst` */
export class TextBodyMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "txBodyMkLst" as const;

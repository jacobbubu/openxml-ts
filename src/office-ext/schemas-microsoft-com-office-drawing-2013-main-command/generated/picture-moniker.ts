...
// @see DocumentFormat.OpenXml.Drawing2013Command.PictureMoniker
 ...
 *
 * Element: `oac:picMk` */
export class PictureMoniker extends OpenXmlLeafElement {
  override readonly localName = "picMk" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "PictureMoniker" });
  }
}

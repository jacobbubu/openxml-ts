...
// @see DocumentFormat.OpenXml.Drawing2013Command.DocumentContextMonikerList
 ...
 *
 * Element: `oac:dcMkLst` */
export class DocumentContextMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "dcMkLst" as const;

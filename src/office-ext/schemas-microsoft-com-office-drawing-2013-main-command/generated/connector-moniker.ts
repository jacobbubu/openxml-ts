...
// @see DocumentFormat.OpenXml.Drawing2013Command.ConnectorMoniker
 ...
 *
 * Element: `oac:cxnSpMk` */
export class ConnectorMoniker extends OpenXmlLeafElement {
  override readonly localName = "cxnSpMk" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "ConnectorMoniker" });
  }
}

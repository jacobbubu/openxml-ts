...
// @see DocumentFormat.OpenXml.Drawing2013Command.TextParagraphPropertiesType
 ...
 *
 * Element: `oac:pPr` */
export class TextParagraphPropertiesType extends OpenXmlCompositeElement {
  override readonly localName = "pPr" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "marL": this.leftMargin = Int32Value.parse(value); assertNumber(this.leftMargin, { min: 0, max: 51206400 }, { attribute: ":marL", elementClass: "TextParagraphPropertiesType" }); return;
      case "marR": this.rightMargin = Int32Value.parse(value); assertNumber(this.rightMargin, { min: 0, max: 51206400 }, { attribute: ":marR", elementClass: "TextParagraphPropertiesType" }); return;
      case "lvl": this.level = Int32Value.parse(value); assertNumber(this.level, { min: 0, max: 8 }, { attribute: ":lvl", elementClass: "TextParagraphPropertiesType" }); return;
      case "indent": this.indent = Int32Value.parse(value); assertNumber(this.indent, { min: -51206400, max: 51206400 }, { attribute: ":indent", elementClass: "TextParagraphPropertiesType" }); return;

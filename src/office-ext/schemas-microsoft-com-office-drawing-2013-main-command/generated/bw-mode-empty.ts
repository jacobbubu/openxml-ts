...
// @see DocumentFormat.OpenXml.Drawing2013Command.BwModeEmpty
 ...
 *
 * Element: `oac:bwMode` */
export class BwModeEmpty extends OpenXmlLeafElement {
  override readonly localName = "bwMode" as const;

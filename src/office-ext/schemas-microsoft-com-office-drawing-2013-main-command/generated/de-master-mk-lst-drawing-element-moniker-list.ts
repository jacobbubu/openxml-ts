...
// @see DocumentFormat.OpenXml.Drawing2013Command.DeMasterMkLstDrawingElementMonikerList
 ...
 *
 * Element: `oac:deMasterMkLst` */
export class DeMasterMkLstDrawingElementMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "deMasterMkLst" as const;

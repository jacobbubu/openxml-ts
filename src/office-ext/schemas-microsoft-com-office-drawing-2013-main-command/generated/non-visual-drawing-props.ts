...
// @see DocumentFormat.OpenXml.Drawing2013Command.NonVisualDrawingProps
 ...
 *
 * Element: `oac:cNvPr` */
export class NonVisualDrawingProps extends OpenXmlCompositeElement {
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "NonVisualDrawingProps" });
    assertRequired(this.name, { attribute: ":name", elementClass: "NonVisualDrawingProps" });
  }
}

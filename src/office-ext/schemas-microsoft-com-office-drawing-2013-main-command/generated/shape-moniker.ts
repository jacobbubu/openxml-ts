...
// @see DocumentFormat.OpenXml.Drawing2013Command.ShapeMoniker
 ...
 *
 * Element: `oac:spMk` */
export class ShapeMoniker extends OpenXmlLeafElement {
  override readonly localName = "spMk" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "ShapeMoniker" });
  }
}

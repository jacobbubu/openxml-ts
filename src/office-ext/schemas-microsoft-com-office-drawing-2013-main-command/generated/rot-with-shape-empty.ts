...
// @see DocumentFormat.OpenXml.Drawing2013Command.RotWithShapeEmpty
 ...
 *
 * Element: `oac:rotWithShape` */
export class RotWithShapeEmpty extends OpenXmlLeafElement {
  override readonly localName = "rotWithShape" as const;

...
// @see DocumentFormat.OpenXml.Drawing2013Command.DeTgtMkLstDrawingElementMonikerList
 ...
 *
 * Element: `oac:deTgtMkLst` */
export class DeTgtMkLstDrawingElementMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "deTgtMkLst" as const;

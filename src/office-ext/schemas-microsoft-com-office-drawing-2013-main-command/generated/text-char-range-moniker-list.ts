...
// @see DocumentFormat.OpenXml.Drawing2013Command.TextCharRangeMonikerList
 ...
 *
 * Element: `oac:txMkLst` */
export class TextCharRangeMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "txMkLst" as const;

...
// @see DocumentFormat.OpenXml.Drawing2013Command.FillRefStyleMatrixReference
 ...
 *
 * Element: `oac:fillRef` */
export class FillRefStyleMatrixReference extends OpenXmlCompositeElement {
  override readonly localName = "fillRef" as const;
  ...
  validateRequired(): void {
    assertRequired(this.index, { attribute: ":idx", elementClass: "FillRefStyleMatrixReference" });
  }
}

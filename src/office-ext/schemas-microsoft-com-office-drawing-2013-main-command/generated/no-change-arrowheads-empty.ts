...
// @see DocumentFormat.OpenXml.Drawing2013Command.NoChangeArrowheadsEmpty
 ...
 *
 * Element: `oac:noChangeArrowheads` */
export class NoChangeArrowheadsEmpty extends OpenXmlLeafElement {
  override readonly localName = "noChangeArrowheads" as const;

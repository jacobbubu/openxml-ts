...
// @see DocumentFormat.OpenXml.Drawing2013Command.NoEditPointsEmpty
 ...
 *
 * Element: `oac:noEditPoints` */
export class NoEditPointsEmpty extends OpenXmlLeafElement {
  override readonly localName = "noEditPoints" as const;

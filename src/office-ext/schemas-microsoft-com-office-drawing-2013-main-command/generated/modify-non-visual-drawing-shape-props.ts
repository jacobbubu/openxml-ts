...
// @see DocumentFormat.OpenXml.Drawing2013Command.ModifyNonVisualDrawingShapeProps
 ...
 *
 * Element: `oac:cNvSpPr` */
export class ModifyNonVisualDrawingShapeProps extends OpenXmlLeafElement {
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "noTextEdit": this.noTextEdit = BooleanValue.parse(value); return;
      case "txBox": this.txBox = BooleanValue.parse(value); return;
    }
  ...
  protected override collectAttributes(): [string, string][] {
    ...
    if (this.noTextEdit !== undefined) out.push(["noTextEdit", this.noTextEdit.toString()]);
    if (this.txBox !== undefined) out.push(["txBox", this.txBox.toString()]);
    return out;
  }

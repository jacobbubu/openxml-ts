...
// @see DocumentFormat.OpenXml.Drawing2013Command.TableMonikerList
 ...
 *
 * Element: `oac:tblMkLst` */
export class TableMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "tblMkLst" as const;

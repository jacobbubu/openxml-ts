...
// @see DocumentFormat.OpenXml.Drawing2013Command.GraphicFrameMonikerList
 ...
 *
 * Element: `oac:graphicFrameMkLst` */
export class GraphicFrameMonikerList extends OpenXmlCompositeElement {
  override readonly localName = "graphicFrameMkLst" as const;

...
// @see DocumentFormat.OpenXml.Drawing2013Command.InkMoniker
 ...
 *
 * Element: `oac:inkMk` */
export class InkMoniker extends OpenXmlLeafElement {
  override readonly localName = "inkMk" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "InkMoniker" });
  }
}

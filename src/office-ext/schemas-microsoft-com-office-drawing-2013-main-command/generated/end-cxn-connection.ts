...
// @see DocumentFormat.OpenXml.Drawing2013Command.EndCxnConnection
 ...
 *
 * Element: `oac:endCxn` */
export class EndCxnConnection extends OpenXmlLeafElement {
  override readonly localName = "endCxn" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "EndCxnConnection" });
    assertRequired(this.index, { attribute: ":idx", elementClass: "EndCxnConnection" });
  }
}

...
// @see DocumentFormat.OpenXml.Drawing2013Command.GraphicFrameMoniker
 ...
 *
 * Element: `oac:graphicFrameMk` */
export class GraphicFrameMoniker extends OpenXmlLeafElement {
  override readonly localName = "graphicFrameMk" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "GraphicFrameMoniker" });
  }
}

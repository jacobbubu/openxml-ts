...
// @see DocumentFormat.OpenXml.Drawing2013Command.NoAdjustHandlesEmpty
 ...
 *
 * Element: `oac:noAdjustHandles` */
export class NoAdjustHandlesEmpty extends OpenXmlLeafElement {
  override readonly localName = "noAdjustHandles" as const;

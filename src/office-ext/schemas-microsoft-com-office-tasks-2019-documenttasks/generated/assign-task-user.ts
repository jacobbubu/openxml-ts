...
// @see DocumentFormat.OpenXml.Tasks2019Documenttasks.AssignTaskUser
 ...
 *
 * Element: `t:Assign` */
export class AssignTaskUser extends OpenXmlLeafElement {
  override readonly localName = "Assign" as const;
  ...
  validateRequired(): void {
    assertRequired(this.userId, { attribute: ":userId", elementClass: "AssignTaskUser" });
    assertRequired(this.userName, { attribute: ":userName", elementClass: "AssignTaskUser" });
    assertRequired(this.userProvider, { attribute: ":userProvider", elementClass: "AssignTaskUser" });
  }
}

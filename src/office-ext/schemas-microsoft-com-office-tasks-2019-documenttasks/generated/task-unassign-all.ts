...
// @see DocumentFormat.OpenXml.Tasks2019Documenttasks.TaskUnassignAll
 ...
 *
 * Element: `t:UnassignAll` */
export class TaskUnassignAll extends OpenXmlLeafElement {
  override readonly localName = "UnassignAll" as const;

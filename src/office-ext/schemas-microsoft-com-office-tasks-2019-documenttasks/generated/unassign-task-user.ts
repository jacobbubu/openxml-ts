...
// @see DocumentFormat.OpenXml.Tasks2019Documenttasks.UnassignTaskUser
 ...
 *
 * Element: `t:Unassign` */
export class UnassignTaskUser extends OpenXmlLeafElement {
  override readonly localName = "Unassign" as const;
  ...
  validateRequired(): void {
    assertRequired(this.userId, { attribute: ":userId", elementClass: "UnassignTaskUser" });
    assertRequired(this.userName, { attribute: ":userName", elementClass: "UnassignTaskUser" });
    assertRequired(this.userProvider, { attribute: ":userProvider", elementClass: "UnassignTaskUser" });
  }
}

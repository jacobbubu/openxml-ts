...
// @see DocumentFormat.OpenXml.Tasks2019Documenttasks.TaskHistory
 ...
 *
 * Element: `t:History` */
export class TaskHistory extends OpenXmlCompositeElement {
  override readonly localName = "History" as const;

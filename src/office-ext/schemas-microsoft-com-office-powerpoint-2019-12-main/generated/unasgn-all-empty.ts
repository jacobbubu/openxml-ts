...
// @see DocumentFormat.OpenXml.201912Main.UnasgnAllEmpty
 ...
 *
 * Element: `p1912:unasgnAll` */
export class UnasgnAllEmpty extends OpenXmlLeafElement {
  override readonly localName = "unasgnAll" as const;

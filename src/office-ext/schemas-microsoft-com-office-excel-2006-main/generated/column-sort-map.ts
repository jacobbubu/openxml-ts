...
// @see DocumentFormat.OpenXml.Excel2006Main.ColumnSortMap
...
/** Column Sort Map.
 *
 * Element: `xne:colSortMap` */
export class ColumnSortMap extends OpenXmlCompositeElement {
  override readonly localName = "colSortMap" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "count": this.count = UInt32Value.parse(value); assertNumber(this.count, { max: 536870910 }, { attribute: ":count", elementClass: "ColumnSortMap" }); return;
    }
  ...
  validateRequired(): void {
    assertRequired(this.ref, { attribute: ":ref", elementClass: "ColumnSortMap" });
  }
}

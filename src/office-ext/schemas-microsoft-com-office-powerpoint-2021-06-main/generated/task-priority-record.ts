...
// @see DocumentFormat.OpenXml.202106Main.TaskPriorityRecord
 ...
 *
 * Element: `p216:pri` */
export class TaskPriorityRecord extends OpenXmlLeafElement {
  override readonly localName = "pri" as const;

...
// @see DocumentFormat.OpenXml.Spreadsheetml2020Richdatawebimage.BlipWebImageSupportingRichDataRelationship
 ...
 *
 * Element: `xlrdwi:blip` */
export class BlipWebImageSupportingRichDataRelationship extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "r:id", elementClass: "BlipWebImageSupportingRichDataRelationship" });
  }
}

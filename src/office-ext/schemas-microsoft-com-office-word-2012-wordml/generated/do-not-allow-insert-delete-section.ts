...
// @see DocumentFormat.OpenXml.Word2012Wordml.DoNotAllowInsertDeleteSection
 ...
 *
 * Element: `w15:doNotAllowInsertDeleteSection` */
export class DoNotAllowInsertDeleteSection extends OpenXmlLeafElement {
  override readonly localName = "doNotAllowInsertDeleteSection" as const;

...
// @see DocumentFormat.OpenXml.Word2012Wordml.FootnoteColumns
...
export class FootnoteColumns extends OpenXmlLeafElement {
  override readonly localName = "footnoteColumns" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: "w:val", elementClass: "FootnoteColumns" });
  }
}

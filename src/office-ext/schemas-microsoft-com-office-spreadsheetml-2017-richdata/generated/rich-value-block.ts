...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata.RichValueBlock
 ...
 *
 * Element: `xlrd:rvb` */
export class RichValueBlock extends OpenXmlLeafElement {
  override readonly localName = "rvb" as const;
  ...
  validateRequired(): void {
    assertRequired(this.i, { attribute: ":i", elementClass: "RichValueBlock" });
  }
}

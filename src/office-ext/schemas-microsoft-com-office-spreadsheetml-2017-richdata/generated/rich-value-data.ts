...
// @see DocumentFormat.OpenXml.Spreadsheetml2017Richdata.RichValueData
 ...
 *
 * Element: `xlrd:rvData` */
export class RichValueData extends OpenXmlCompositeElement {
  override readonly localName = "rvData" as const;
  ...
  validateRequired(): void {
    assertRequired(this.count, { attribute: ":count", elementClass: "RichValueData" });
  }
}

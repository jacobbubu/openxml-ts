...
// @see DocumentFormat.OpenXml.Webextension201011.WebExtensionPropertyBag
 ...
 *
 * Element: `we:properties` */
export class WebExtensionPropertyBag extends OpenXmlCompositeElement {
  override readonly localName = "properties" as const;

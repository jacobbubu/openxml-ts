...
// @see DocumentFormat.OpenXml.Webextension201011.WebExtensionReferenceList
 ...
 *
 * Element: `we:alternateReferences` */
export class WebExtensionReferenceList extends OpenXmlCompositeElement {
  override readonly localName = "alternateReferences" as const;

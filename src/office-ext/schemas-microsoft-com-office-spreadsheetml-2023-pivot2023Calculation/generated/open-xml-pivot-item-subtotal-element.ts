...
// @see DocumentFormat.OpenXml.Spreadsheetml2023Pivot2023Calculation.OpenXmlPivotItemSubtotalElement
...
export abstract class OpenXmlPivotItemSubtotalElement extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.subtotalType, { attribute: ":subtotalType", elementClass: "OpenXmlPivotItemSubtotalElement" });
    assertRequired(this.itemLocation, { attribute: ":itemLocation", elementClass: "OpenXmlPivotItemSubtotalElement" });
  }
}

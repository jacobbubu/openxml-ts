...
// @see DocumentFormat.OpenXml.Spreadsheetml2023Pivot2023Calculation.SubtotalLineItemPivotItemSubtotal
 ...
 *
 * Element: `xlpcalc:subtotalLineItem` */
export class SubtotalLineItemPivotItemSubtotal extends OpenXmlLeafElement {
  override readonly localName = "subtotalLineItem" as const;
  ...
  validateRequired(): void {
    assertRequired(this.subtotalType, { attribute: ":subtotalType", elementClass: "SubtotalLineItemPivotItemSubtotal" });
    assertRequired(this.itemLocation, { attribute: ":itemLocation", elementClass: "SubtotalLineItemPivotItemSubtotal" });
  }
}

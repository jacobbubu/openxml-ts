...
// @see DocumentFormat.OpenXml.200601Customui.QuickAccessToolbar
 ...
 *
 * Element: `mso:qat` */
export class QuickAccessToolbar extends OpenXmlCompositeElement {
  override readonly localName = "qat" as const;

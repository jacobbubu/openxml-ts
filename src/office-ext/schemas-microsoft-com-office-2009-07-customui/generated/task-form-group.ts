...
// @see DocumentFormat.OpenXml.200907Customui.TaskFormGroup
 ...
 *
 * Element: `mso14:taskFormGroup` */
export class TaskFormGroup extends OpenXmlCompositeElement {
  override readonly localName = "taskFormGroup" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "idQ": this.qualifiedId = StringValue.parse(value); assertString(this.qualifiedId, { maxLength: 1024, minLength: 1 }, { attribute: ":idQ", elementClass: "TaskFormGroup" }); return;
      case "tag": this.tag = StringValue.parse(value); assertString(this.tag, { maxLength: 1024, minLength: 1 }, { attribute: ":tag", elementClass: "TaskFormGroup" }); return;
      case "idMso": this.idMso = StringValue.parse(value); assertString(this.idMso, { maxLength: 1024, minLength: 1 }, { attribute: ":idMso", elementClass: "TaskFormGroup" }); return;
      case "label": this.label = StringValue.parse(value); assertString(this.label, { maxLength: 1024, minLength: 1 }, { attribute: ":label", elementClass: "TaskFormGroup" }); return;
      case "getLabel": this.getLabel = StringValue.parse(value); assertString(this.getLabel, { maxLength: 1024, minLength: 1 }, { attribute: ":getLabel", elementClass: "TaskFormGroup" }); return;
      case "visible": this.visible = BooleanValue.parse(value); return;
      case "getVisible": this.getVisible = StringValue.parse(value); assertString(this.getVisible, { maxLength: 1024, minLength: 1 }, { attribute: ":getVisible", elementClass: "TaskFormGroup" }); return;
      case "helperText": this.helperText = StringValue.parse(value); assertString(this.helperText, { maxLength: 4096, minLength: 1 }, { attribute: ":helperText", elementClass: "TaskFormGroup" }); return;

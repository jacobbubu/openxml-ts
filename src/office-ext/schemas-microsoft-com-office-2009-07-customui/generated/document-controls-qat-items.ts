...
// @see DocumentFormat.OpenXml.200907Customui.DocumentControlsQatItems
 ...
 *
 * Element: `mso14:documentControls` */
export class DocumentControlsQatItems extends OpenXmlCompositeElement {
  override readonly localName = "documentControls" as const;

...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.FpbsFeaturePropertyBags
 ...
 *
 * Element: `xfpb:fpbs` */
export class FpbsFeaturePropertyBags extends OpenXmlCompositeElement {
  override readonly localName = "fpbs" as const;

...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.HeaderRowBorderRevDxfTableRevDxf
 ...
 *
 * Element: `xfpb:headerRowBorderRevDxf` */
export class HeaderRowBorderRevDxfTableRevDxf extends OpenXmlCompositeElement {
  override readonly localName = "headerRowBorderRevDxf" as const;

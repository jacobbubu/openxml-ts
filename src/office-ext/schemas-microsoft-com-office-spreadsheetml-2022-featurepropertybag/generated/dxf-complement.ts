...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.DXFComplement
 ...
 *
 * Element: `xfpb:DXFComplement` */
export class DXFComplement extends OpenXmlLeafElement {
  override readonly localName = "DXFComplement" as const;
  ...
  validateRequired(): void {
    assertRequired(this.i, { attribute: ":i", elementClass: "DXFComplement" });
  }
}

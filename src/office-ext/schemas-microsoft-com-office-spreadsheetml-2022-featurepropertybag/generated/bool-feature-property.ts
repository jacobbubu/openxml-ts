...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.BoolFeatureProperty
 ...
 *
 * Element: `xfpb:b` */
export class BoolFeatureProperty extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.k, { attribute: ":k", elementClass: "BoolFeatureProperty" });
  }
}

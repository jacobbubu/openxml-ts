...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.TableBorderRevDxfTableRevDxf
 ...
 *
 * Element: `xfpb:tableBorderRevDxf` */
export class TableBorderRevDxfTableRevDxf extends OpenXmlCompositeElement {
  override readonly localName = "tableBorderRevDxf" as const;

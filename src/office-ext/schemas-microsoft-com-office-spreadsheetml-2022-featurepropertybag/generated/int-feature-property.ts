...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.IntFeatureProperty
 ...
 *
 * Element: `xfpb:i` */
export class IntFeatureProperty extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.k, { attribute: ":k", elementClass: "IntFeatureProperty" });
  }
}

...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.ColumnBodyRevDxfTableRevDxf
 ...
 *
 * Element: `xfpb:columnBodyRevDxf` */
export class ColumnBodyRevDxfTableRevDxf extends OpenXmlCompositeElement {
  override readonly localName = "columnBodyRevDxf" as const;

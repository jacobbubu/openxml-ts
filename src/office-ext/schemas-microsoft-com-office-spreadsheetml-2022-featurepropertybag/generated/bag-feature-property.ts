...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.BagFeatureProperty
 ...
 *
 * Element: `xfpb:bagId` */
export class BagFeatureProperty extends OpenXmlLeafElement {
  override readonly localName = "bagId" as const;
  ...
  validateRequired(): void {
    assertRequired(this.k, { attribute: ":k", elementClass: "BagFeatureProperty" });
  }
}

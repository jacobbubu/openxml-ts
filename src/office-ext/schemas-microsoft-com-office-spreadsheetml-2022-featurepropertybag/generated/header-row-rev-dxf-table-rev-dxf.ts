...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.HeaderRowRevDxfTableRevDxf
 ...
 *
 * Element: `xfpb:headerRowRevDxf` */
export class HeaderRowRevDxfTableRevDxf extends OpenXmlCompositeElement {
  override readonly localName = "headerRowRevDxf" as const;

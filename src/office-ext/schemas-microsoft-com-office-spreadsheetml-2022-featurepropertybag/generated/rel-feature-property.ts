...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.RelFeatureProperty
 ...
 *
 * Element: `xfpb:rel` */
export class RelFeatureProperty extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.k, { attribute: ":k", elementClass: "RelFeatureProperty" });
  }
}

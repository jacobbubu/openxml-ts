...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.DecimalFeatureProperty
 ...
 *
 * Element: `xfpb:d` */
export class DecimalFeatureProperty extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.k, { attribute: ":k", elementClass: "DecimalFeatureProperty" });
  }
}

...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.DifferentialFormatType
 ...
 *
 * Element: `xfpb:dxf` */
export class DifferentialFormatType extends OpenXmlCompositeElement {
  override readonly localName = "dxf" as const;

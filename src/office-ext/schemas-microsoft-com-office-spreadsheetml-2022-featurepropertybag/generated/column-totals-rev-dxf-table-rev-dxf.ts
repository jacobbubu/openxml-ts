...
// @see DocumentFormat.OpenXml.Spreadsheetml2022Featurepropertybag.ColumnTotalsRevDxfTableRevDxf
 ...
 *
 * Element: `xfpb:columnTotalsRevDxf` */
export class ColumnTotalsRevDxfTableRevDxf extends OpenXmlCompositeElement {
  override readonly localName = "columnTotalsRevDxf" as const;

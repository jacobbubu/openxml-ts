...
// @see DocumentFormat.OpenXml.201612Diagram.ShapeProperties
 ...
 *
 * Element: `dgm1612:spPr` */
export class ShapeProperties extends OpenXmlCompositeElement {
  override readonly localName = "spPr" as const;
  override readonly prefix = "dgm1612" as const;
  override readonly namespaceUri = "http://schemas.microsoft.com/office/drawing/2016/12/diagram" as const;

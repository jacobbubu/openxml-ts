...
// @see DocumentFormat.OpenXml.Drawing2017Model3d.SxRatio
 ...
 *
 * Element: `am3d:sx` */
export class SxRatio extends OpenXmlLeafElement {
  override readonly localName = "sx" as const;
  ...
  validateRequired(): void {
    assertRequired(this.numerator, { attribute: ":n", elementClass: "SxRatio" });
    assertRequired(this.denominator, { attribute: ":d", elementClass: "SxRatio" });
  }
}

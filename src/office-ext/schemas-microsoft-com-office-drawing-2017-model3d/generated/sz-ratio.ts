...
// @see DocumentFormat.OpenXml.Drawing2017Model3d.SzRatio
 ...
 *
 * Element: `am3d:sz` */
export class SzRatio extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.numerator, { attribute: ":n", elementClass: "SzRatio" });
    assertRequired(this.denominator, { attribute: ":d", elementClass: "SzRatio" });
  }
}

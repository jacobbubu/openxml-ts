...
// @see DocumentFormat.OpenXml.Drawing2017Model3d.SzPositiveRatio
 ...
 *
 * Element: `am3d:sz` */
export class SzPositiveRatio extends OpenXmlLeafElement {
  override readonly localName = "sz" as const;
  ...
  validateRequired(): void {
    assertRequired(this.n, { attribute: ":n", elementClass: "SzPositiveRatio" });
    assertRequired(this.d, { attribute: ":d", elementClass: "SzPositiveRatio" });
  }
}

...
// @see DocumentFormat.OpenXml.Drawing2017Model3d.IntensityPositiveRatio
 ...
 *
 * Element: `am3d:intensity` */
export class IntensityPositiveRatio extends OpenXmlLeafElement {
  override readonly localName = "intensity" as const;
  ...
  validateRequired(): void {
    assertRequired(this.n, { attribute: ":n", elementClass: "IntensityPositiveRatio" });
    assertRequired(this.d, { attribute: ":d", elementClass: "IntensityPositiveRatio" });
  }
}

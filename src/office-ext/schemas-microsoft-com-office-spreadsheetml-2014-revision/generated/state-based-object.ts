...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.StateBasedObject
 ...
 *
 * Element: `xr:objectState` */
export class StateBasedObject extends OpenXmlCompositeElement {
  override readonly localName = "objectState" as const;

...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RefMap
 ...
 *
 * Element: `xr:refmap` */
export class RefMap extends OpenXmlCompositeElement {
  override readonly localName = "refmap" as const;

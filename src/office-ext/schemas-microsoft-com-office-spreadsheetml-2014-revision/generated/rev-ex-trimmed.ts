...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RevExTrimmed
 ...
 *
 * Element: `xr:xrrTrim` */
export class RevExTrimmed extends OpenXmlLeafElement {
  override readonly localName = "xrrTrim" as const;
  ...
  validateRequired(): void {
    assertRequired(this.rev, { attribute: ":rev", elementClass: "RevExTrimmed" });
    assertRequired(this.uid, { attribute: ":uid", elementClass: "RevExTrimmed" });
    assertRequired(this.sh, { attribute: ":sh", elementClass: "RevExTrimmed" });
  }
}

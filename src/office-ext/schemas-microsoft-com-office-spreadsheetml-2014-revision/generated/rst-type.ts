...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RstType
 ...
 *
 * Element: `xr:is` */
export class RstType extends OpenXmlCompositeElement {
  override readonly localName = "is" as const;

...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RevisionStateLink
 ...
 *
 * Element: `xr:link` */
export class RevisionStateLink extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "r:id", elementClass: "RevisionStateLink" });
  }
}

...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RevExFuture
 ...
 *
 * Element: `xr:xrrftr` */
export class RevExFuture extends OpenXmlCompositeElement {
  override readonly localName = "xrrftr" as const;
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      ...
      case "sti": this.sti = BooleanValue.parse(value); return;
    }
  ...
  protected override collectAttributes(): [string, string][] {
    ...
    if (this.sti !== undefined) out.push(["sti", this.sti.toString()]);
    return out;
  }

  /** 校验所有 RequiredValidator 标注的属性都存在；缺失抛 REQUIRED_ATTR_MISSING。 */
  validateRequired(): void {
    assertRequired(this.rev, { attribute: ":rev", elementClass: "RevExFuture" });
    assertRequired(this.uid, { attribute: ":uid", elementClass: "RevExFuture" });
    assertRequired(this.sh, { attribute: ":sh", elementClass: "RevExFuture" });
  }
}

...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RevExDelObj
 ...
 *
 * Element: `xr:xrrdo` */
export class RevExDelObj extends OpenXmlCompositeElement {
  override readonly localName = "xrrdo" as const;
  ...
  validateRequired(): void {
    assertRequired(this.rev, { attribute: ":rev", elementClass: "RevExDelObj" });
    assertRequired(this.uid, { attribute: ":uid", elementClass: "RevExDelObj" });
    assertRequired(this.sh, { attribute: ":sh", elementClass: "RevExDelObj" });
  }
}

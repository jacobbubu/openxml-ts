...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RevExMove
 ...
 *
 * Element: `xr:xrrm` */
export class RevExMove extends OpenXmlLeafElement {
  override readonly localName = "xrrm" as const;

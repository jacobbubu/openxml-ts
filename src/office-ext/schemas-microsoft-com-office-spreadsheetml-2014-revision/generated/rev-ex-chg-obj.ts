...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RevExChgObj
 ...
 *
 * Element: `xr:xrrco` */
export class RevExChgObj extends OpenXmlCompositeElement {
  override readonly localName = "xrrco" as const;
  ...
  validateRequired(): void {
    assertRequired(this.rev, { attribute: ":rev", elementClass: "RevExChgObj" });
    assertRequired(this.uid, { attribute: ":uid", elementClass: "RevExChgObj" });
    assertRequired(this.sh, { attribute: ":sh", elementClass: "RevExChgObj" });
  }
}

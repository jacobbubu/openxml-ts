...
// @see DocumentFormat.OpenXml.Spreadsheetml2014Revision.RevGroup
 ...
 *
 * Element: `xr:xrrg` */
export class RevGroup extends OpenXmlCompositeElement {
  override readonly localName = "xrrg" as const;
  ...
  validateRequired(): void {
    assertRequired(this.rev, { attribute: ":rev", elementClass: "RevGroup" });
    assertRequired(this.uid, { attribute: ":uid", elementClass: "RevGroup" });
    assertRequired(this.sh, { attribute: ":sh", elementClass: "RevGroup" });
  }
}

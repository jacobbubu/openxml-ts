...
// @see DocumentFormat.OpenXml.200304Emma.Emma
 ...
 *
 * Element: `emma:emma` */
export class Emma extends OpenXmlCompositeElement {
  override readonly localName = "emma" as const;
  ...
  validateRequired(): void {
    assertRequired(this.version, { attribute: ":version", elementClass: "Emma" });
  }
}

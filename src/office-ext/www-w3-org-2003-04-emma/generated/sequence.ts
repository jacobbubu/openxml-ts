...
// @see DocumentFormat.OpenXml.200304Emma.Sequence
 ...
 *
 * Element: `emma:sequence` */
export class Sequence extends OpenXmlCompositeElement {
  override readonly localName = "sequence" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "Sequence" });
  }
}

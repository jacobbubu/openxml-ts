...
// @see DocumentFormat.OpenXml.200304Emma.OneOf
 ...
 *
 * Element: `emma:one-of` */
export class OneOf extends OpenXmlCompositeElement {
  override readonly localName = "one-of" as const;
  override readonly prefix = "emma" as const;
  override readonly namespaceUri = "http://www.w3.org/2003/04/emma" as const;
  override readonly children: OpenXmlElementList = new OpenXmlElementList(this);

  /** disjunction-type (:disjunction-type) */
  ...
  override applyAttribute(qname: string, value: string): void {
    switch (qname) {
      case "disjunction-type": this.disjunctionType = StringValue.parse(value); return;
      ...
      case "emma:confidence": this.confidence = DecimalValue.parse(value); assertNumber(this.confidence, { min: 0, max: 1 }, { attribute: "emma:confidence", elementClass: "OneOf" }); return;
      ...
      case "emma:cost": this.cost = DecimalValue.parse(value); assertNumber(this.cost, { min: 0, max: 10000000 }, { attribute: "emma:cost", elementClass: "OneOf" }); return;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "OneOf" });
  }
}

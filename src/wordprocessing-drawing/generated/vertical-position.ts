...
// @see DocumentFormat.OpenXml.WordprocessingDrawing.VerticalPosition
...
export class VerticalPosition extends OpenXmlCompositeElement {
  override readonly localName = "positionV" as const;
  ...
  /** Vertical Position Relative Base (:relativeFrom) */
  ...
  validateRequired(): void {
    assertRequired(this.relativeFrom, { attribute: ":relativeFrom", elementClass: "VerticalPosition" });
  }
}

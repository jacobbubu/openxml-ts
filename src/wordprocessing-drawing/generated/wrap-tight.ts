...
// @see DocumentFormat.OpenXml.WordprocessingDrawing.WrapTight
...
export class WrapTight extends OpenXmlCompositeElement {
  override readonly localName = "wrapTight" as const;
  ...
  /** Distance From Test on Left Edge (:distL) */
  ...
  validateRequired(): void {
    assertRequired(this.wrapText, { attribute: ":wrapText", elementClass: "WrapTight" });
  }
}

...
// @see DocumentFormat.OpenXml.WordprocessingDrawing.WrapSquare
...
export class WrapSquare extends OpenXmlCompositeElement {
  override readonly localName = "wrapSquare" as const;
  ...
  validateRequired(): void {
    assertRequired(this.wrapText, { attribute: ":wrapText", elementClass: "WrapSquare" });
  }
}

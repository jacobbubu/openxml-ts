...
// @see DocumentFormat.OpenXml.WordprocessingDrawing.DocProperties
...
export class DocProperties extends OpenXmlCompositeElement {
  override readonly localName = "docPr" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: ":id", elementClass: "DocProperties" });
    assertRequired(this.name, { attribute: ":name", elementClass: "DocProperties" });
  }
}

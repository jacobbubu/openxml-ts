...
// @see DocumentFormat.OpenXml.Ppt2010.NullEventRecord
...
export class NullEventRecord extends OpenXmlLeafElement {
  override readonly localName = "nullEvt" as const;
  ...
  validateRequired(): void {
    assertRequired(this.time, { attribute: ":time", elementClass: "NullEventRecord" });
    assertRequired(this.objectId, { attribute: ":objId", elementClass: "NullEventRecord" });
  }
}

...
// @see DocumentFormat.OpenXml.Ppt2010.StopEventRecord
...
export class StopEventRecord extends OpenXmlLeafElement {
  override readonly localName = "stopEvt" as const;
  ...
  validateRequired(): void {
    assertRequired(this.time, { attribute: ":time", elementClass: "StopEventRecord" });
    assertRequired(this.objectId, { attribute: ":objId", elementClass: "StopEventRecord" });
  }
}

...
// @see DocumentFormat.OpenXml.Ppt2010.ResumeEventRecord
 ...
 *
 * Element: `p14:resumeEvt` */
export class ResumeEventRecord extends OpenXmlLeafElement {
  override readonly localName = "resumeEvt" as const;
  ...
  validateRequired(): void {
    assertRequired(this.time, { attribute: ":time", elementClass: "ResumeEventRecord" });
    assertRequired(this.objectId, { attribute: ":objId", elementClass: "ResumeEventRecord" });
  }
}

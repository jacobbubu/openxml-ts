...
// @see DocumentFormat.OpenXml.Ppt2010.ShowMediaControls
 ...
 *
 * Element: `p14:showMediaCtrls` */
export class ShowMediaControls extends OpenXmlLeafElement {
  override readonly localName = "showMediaCtrls" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "ShowMediaControls" });
  }
}

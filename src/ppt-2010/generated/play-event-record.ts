...
// @see DocumentFormat.OpenXml.Ppt2010.PlayEventRecord
...
export class PlayEventRecord extends OpenXmlLeafElement {
  override readonly localName = "playEvt" as const;
  ...
  validateRequired(): void {
    assertRequired(this.time, { attribute: ":time", elementClass: "PlayEventRecord" });
    assertRequired(this.objectId, { attribute: ":objId", elementClass: "PlayEventRecord" });
  }
}

...
// @see DocumentFormat.OpenXml.Ppt2010.PauseEventRecord
 ...
 *
 * Element: `p14:pauseEvt` */
export class PauseEventRecord extends OpenXmlLeafElement {
  override readonly localName = "pauseEvt" as const;
  ...
  validateRequired(): void {
    assertRequired(this.time, { attribute: ":time", elementClass: "PauseEventRecord" });
    assertRequired(this.objectId, { attribute: ":objId", elementClass: "PauseEventRecord" });
  }
}

...
// @see DocumentFormat.OpenXml.Ppt2010.DiscardImageEditData
 ...
 *
 * Element: `p14:discardImageEditData` */
export class DiscardImageEditData extends OpenXmlLeafElement {
  override readonly localName = "discardImageEditData" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "DiscardImageEditData" });
  }
}

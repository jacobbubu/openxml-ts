...
// @see DocumentFormat.OpenXml.Ppt2010.ModificationId
...
export class ModificationId extends OpenXmlLeafElement {
  override readonly localName = "modId" as const;
  ...
  validateRequired(): void {
    assertRequired(this.val, { attribute: ":val", elementClass: "ModificationId" });
  }
}

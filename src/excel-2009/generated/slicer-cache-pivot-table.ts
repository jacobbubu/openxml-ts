...
// @see DocumentFormat.OpenXml.Excel2009.SlicerCachePivotTable
...
export class SlicerCachePivotTable extends OpenXmlLeafElement {
  ...
  validateRequired(): void {
    assertRequired(this.tabId, { attribute: ":tabId", elementClass: "SlicerCachePivotTable" });
    assertRequired(this.name, { attribute: ":name", elementClass: "SlicerCachePivotTable" });
  }
}

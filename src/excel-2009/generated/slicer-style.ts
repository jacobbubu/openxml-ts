...
// @see DocumentFormat.OpenXml.Excel2009.SlicerStyle
 ...
 *
 * Element: `x14:slicerStyle` */
export class SlicerStyle extends OpenXmlCompositeElement {
  override readonly localName = "slicerStyle" as const;
  ...
  validateRequired(): void {
    assertRequired(this.name, { attribute: ":name", elementClass: "SlicerStyle" });
  }
}

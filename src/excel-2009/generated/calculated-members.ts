...
// @see DocumentFormat.OpenXml.Excel2009.CalculatedMembers
 ...
 *
 * Element: `x14:calculatedMembers` */
export class CalculatedMembers extends OpenXmlCompositeElement {
  override readonly localName = "calculatedMembers" as const;
  ...
  /** Calculated Members Count (:count) */

...
// @see DocumentFormat.OpenXml.Excel2009.SlicerCache
 ...
 *
 * Element: `x14:slicerCache` */
export class SlicerCache extends OpenXmlLeafElement {
  override readonly localName = "slicerCache" as const;
  ...
  validateRequired(): void {
    assertRequired(this.id, { attribute: "r:id", elementClass: "SlicerCache" });
  }
}
